...
class MonitorJson(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(MonitorJson.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(MonitorJson, "id").fset)
    ...
    def monitor(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(MonitorJson, "monitor").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def url(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(MonitorJson, "url").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class MonitorJsonConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(MonitorJsonConfig.__init__)
