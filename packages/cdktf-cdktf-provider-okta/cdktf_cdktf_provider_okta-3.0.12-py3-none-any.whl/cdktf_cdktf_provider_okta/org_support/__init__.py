...
class OrgSupport(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(OrgSupport.__init__)
    ...
    def extend_by(self, value: jsii.Number) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(OrgSupport, "extend_by").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(OrgSupport, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class OrgSupportConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(OrgSupportConfig.__init__)
