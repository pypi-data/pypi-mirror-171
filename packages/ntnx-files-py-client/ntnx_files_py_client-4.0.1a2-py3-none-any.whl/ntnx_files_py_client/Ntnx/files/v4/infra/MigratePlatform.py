...
class MigratePlatform(object):
    """MigratePlatform - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def __init__(self, pc_config=None, *args, **kwargs):  # noqa: E501
        """MigratePlatform - a model defined in Swagger
    ...
    def _initialize_object_type(self):
        return 'files.v4.infra.MigratePlatform'

    def _initialize_fq_object_type(self):
        return 'files.v4.r0.a2.infra.MigratePlatform'
    ...
    def to_dict(self):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MigratePlatform, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MigratePlatform):
            return False
