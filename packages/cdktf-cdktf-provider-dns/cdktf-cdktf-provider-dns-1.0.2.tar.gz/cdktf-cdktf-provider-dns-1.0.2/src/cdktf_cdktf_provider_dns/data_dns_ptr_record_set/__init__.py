...
class DataDnsPtrRecordSet(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DataDnsPtrRecordSet.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataDnsPtrRecordSet, "id").fset)
    ...
    def ip_address(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataDnsPtrRecordSet, "ip_address").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class DataDnsPtrRecordSetConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(DataDnsPtrRecordSetConfig.__init__)
