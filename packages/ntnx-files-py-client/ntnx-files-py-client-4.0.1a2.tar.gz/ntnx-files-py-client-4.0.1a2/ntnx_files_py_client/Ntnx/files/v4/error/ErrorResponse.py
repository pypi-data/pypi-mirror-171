...
from ntnx_files_py_client.Ntnx.OneOffiles.v4.error.ErrorResponseerror import ErrorResponseerror  # noqa: F401,E501
...
class ErrorResponse(object):
    ...
    def _initialize_fq_object_type(self):
        return 'files.v4.r0.a2.error.ErrorResponse'
    ...
    @property
    def error(self):
        """`{ list[files.v4.error.AppMessage] | files.v4.error.SchemaValidationError }`
