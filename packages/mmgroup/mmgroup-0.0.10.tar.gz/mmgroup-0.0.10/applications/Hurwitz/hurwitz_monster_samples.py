...
verifiers = [0x803ec3b1084de299, 0x8ddc27f9734482e9]
hurwitz_monster_data.append((g3, ge, verifiers))


# Generators of the Monster as a Hurwitz group 
# found after 11350000 trials

g3 ='M0<y_725h*x_1fbh*d_7deh*p_22326807*l_2*p_1627200>'
ge ='M0<y_20dh*x_1ca4h*d_67dh*p_68438460*t_2*p_165453947*l_2*t_1*p_207349878*l_2*t_2*p_26705322*l_1*t_1*p_97873271*l_2*t_2*p_182779161*l_2*t_2*p_212385311*l_2*t_1*p_172547169*l_2>'
verifiers = [0x470a2335dfaafa6b, 0x02a77a36e9b73b28]
hurwitz_monster_data.append((g3, ge, verifiers))
...
verifiers = [0xba60d7a14176aaef, 0x4a5735e87126a3de]
hurwitz_monster_data.append((g3, ge, verifiers))
...
verifiers = [0x8bf761189bf2bb7c, 0xcaeb589b20db8454]
hurwitz_monster_data.append((g3, ge, verifiers))
...
verifiers = [0x5981c035fddfbbcb, 0x13b5538d5762991f]
hurwitz_monster_data.append((g3, ge, verifiers))
...
verifiers = [0xf9c0f5dd1dc4359b, 0xe2a0e1177f6a7c61]
hurwitz_monster_data.append((g3, ge, verifiers))
...
verifiers = [0x39196d17cc534d42, 0xf09a285e1983a501]
hurwitz_monster_data.append((g3, ge, verifiers))
