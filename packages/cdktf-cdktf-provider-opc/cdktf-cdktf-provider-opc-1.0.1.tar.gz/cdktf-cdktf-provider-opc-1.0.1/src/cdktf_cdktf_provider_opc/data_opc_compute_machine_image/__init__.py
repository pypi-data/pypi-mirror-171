...
class DataOpcComputeMachineImage(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DataOpcComputeMachineImage.__init__)
    ...
    def account(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataOpcComputeMachineImage, "account").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataOpcComputeMachineImage, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataOpcComputeMachineImage, "name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class DataOpcComputeMachineImageConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(DataOpcComputeMachineImageConfig.__init__)
