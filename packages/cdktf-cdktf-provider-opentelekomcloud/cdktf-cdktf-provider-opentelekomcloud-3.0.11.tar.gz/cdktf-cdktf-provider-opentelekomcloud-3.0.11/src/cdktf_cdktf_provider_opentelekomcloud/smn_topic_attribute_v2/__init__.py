...
class SmnTopicAttributeV2(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SmnTopicAttributeV2.__init__)
    ...
    def attribute_name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(SmnTopicAttributeV2, "attribute_name").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(SmnTopicAttributeV2, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def topic_attribute(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(SmnTopicAttributeV2, "topic_attribute").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def topic_urn(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(SmnTopicAttributeV2, "topic_urn").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class SmnTopicAttributeV2Config(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(SmnTopicAttributeV2Config.__init__)
