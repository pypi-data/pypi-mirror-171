...
def nlp(nl, language="en", online=True, datasets=None, dataframe=None, response_type="deanonymize", token="",
    ...
    if datasets is not None and dataframe is not None:
        ...
        online = True
        if response_type not in ["anonymize", "nl2query", "deanonymize"]:
