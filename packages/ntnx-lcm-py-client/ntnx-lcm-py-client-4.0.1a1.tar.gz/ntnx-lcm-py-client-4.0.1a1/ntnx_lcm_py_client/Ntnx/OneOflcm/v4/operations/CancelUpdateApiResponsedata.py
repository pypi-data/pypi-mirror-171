...
class CancelUpdateApiResponsedata(object):
    """CancelUpdateApiResponsedata - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_object_type(self):
        return 'OneOflcm.v4.operations.CancelUpdateApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in CancelUpdateApiResponsedata.discriminator_value_class_map.values():
            return list(CancelUpdateApiResponsedata.discriminator_value_class_map.keys())[list(CancelUpdateApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
    ...
    def to_dict(self):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CancelUpdateApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CancelUpdateApiResponsedata):
            return False
