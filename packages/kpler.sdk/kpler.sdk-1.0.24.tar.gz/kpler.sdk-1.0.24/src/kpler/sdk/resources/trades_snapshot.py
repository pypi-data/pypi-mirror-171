...
from kpler.sdk.helpers import (
    process_snapshot_date_parameter,
...
class TradesSnapshot(KplerClient):
    ...
    def get_columns(self) -> DataFrame:
        """
        This endpoint Provides the last snapshot of all trades. The snapshot is a result of getTrades for all zones, vessels, and products, overall the history..
    ...
    def get(
        ...
        query_parameters: Dict[str, Optional[Any]] = {
            ...
            "startDate": process_snapshot_date_parameter(start_date),
            "endDate": process_snapshot_date_parameter(end_date),
