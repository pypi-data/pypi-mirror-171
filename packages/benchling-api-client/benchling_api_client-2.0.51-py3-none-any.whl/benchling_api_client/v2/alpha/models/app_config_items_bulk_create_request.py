...
class AppConfigItemsBulkCreateRequest:
    ...
    _app_configuration_items: List[AppConfigItemCreate]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        app_configuration_items = (
            ...
            else cast(List[AppConfigItemCreate], UNSET)
        )
    ...
    @property
    def app_configuration_items(self) -> List[AppConfigItemCreate]:
    ...
    def app_configuration_items(self, value: List[AppConfigItemCreate]) -> None:
