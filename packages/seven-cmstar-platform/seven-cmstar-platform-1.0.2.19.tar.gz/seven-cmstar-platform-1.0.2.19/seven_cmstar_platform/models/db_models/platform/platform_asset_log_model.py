...
class PlatformAssetLogModel(BaseModel):
    def __init__(self, db_connect_key='db_platform', sub_table=None, db_transaction=None, context=None):
        super(PlatformAssetLogModel, self).__init__(PlatformAssetLog, sub_table)
...
class PlatformAssetLog:

    def __init__(self):
        super(PlatformAssetLog, self).__init__()
        self.id = 0  # id
        self.app_id = ""  # 应用标识
        self.act_id = 0  # 活动标识
