...
class ThrustBearingOilTankMetalIncrementOverLimitDiagnosis(MultipleThresholds_GreaterEqualTo_LesserThan):
    def __init__(self, *args, **kwargs):
        """
        推力轴承油槽金属颗粒增加量超限判断

        :math:`T < 800, 推力轴承油槽金属颗粒增加量正常`

        :math:`T ≥ 800, 推力轴承油槽金属颗粒数量增加量超限`
        ...
        truthTable:
            dict,报警真值表,形如:{
            "10": {"dfem_evidence": "[推力轴承油槽金属颗粒数量增加量]正常", "dfem_code": ""},
            "01": {"dfem_evidence": "[推力轴承油槽金属颗粒数量增加量]实测值(measured)超限报警,阈值threshold", "dfem_code": "SP000570"},
        }
