...
class RigOperationIngestion(WellsBaseModel):
    ...
    wellbore_asset_external_id: str = Field(
        ...,
        alias="wellboreAssetExternalId",
        description="The CDF asset external id of the wellbore where the operation taken place.\nThe asset must have been ingested as a wellbore with the same source\nas this Rig Operation.\n",
    )
    source: SourceExternalId = Field(..., description="The source external ID in CDF.")
    rig_name: str = Field(..., alias="rigName", max_length=255)
    start_time: Optional[int] = Field(
...
class RigOperationFilter(WellsBaseModel):
    ...
    rig_names: Optional[List[str]] = Field(None, alias="rigNames", example=["Rig A", "15 aerA"])
