...
class Ui_MainClientWindow(object):
    def setupUi(self, MainClientWindow):
        ...
        self.message_text.setGeometry(QtCore.QRect(300, 360, 441, 71))
        ...
        self.messages_list.setGeometry(QtCore.QRect(300, 20, 441, 301))
        ...
        self.btn_clear.clicked.connect(self.message_text.clear)
        QtCore.QMetaObject.connectSlotsByName(MainClientWindow)

    def retranslateUi(self, MainClientWindow):
        _translate = QtCore.QCoreApplication.translate
        MainClientWindow.setWindowTitle(_translate("MainClientWindow", "GB course PyQt&ORM chat"))
        ...
        self.menu_2.setTitle(_translate("MainClientWindow", "Contcts"))
