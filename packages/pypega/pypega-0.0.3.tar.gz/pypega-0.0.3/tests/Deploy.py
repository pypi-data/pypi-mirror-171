##from PegaDM_Environment import *
##from PegaDM_Environment_Orchestrator import *
##from PegaDM_Environment_Candidate import *

import pyPega
import sys

## Orchestrator initalisation
orchestrator = pyPega.pega_deployment_manager_candidate
("orchestrator", "https://sleij.pegatsdemo.com/prweb")

## OAuth 2.0 authentication for Orchestrator environment
orchestrator.set_authentication_method(
    Pega.AUTHENTICATION_METHOD_OAUTH2_CLIENT_CREDENTIALS,
...
auto_retry_task_types = [
    Pega.DEPLOYMENT_TASK_TYPE_GENERATE_ARTIFACT
]
auto_skip_task_types = [
    Pega.DEPLOYMENT_TASK_TYPE_VERIFY_SECURITY_CHECKLIST,
    Pega.DEPLOYMENT_TASK_TYPE_CHECK_GUARDRAIL_COMPLIANCE,
]
auto_approve_task_types = [
    Pega.DEPLOYMENT_TASK_TYPE_PERFORM_MANUAL_STEP
]
