...
class _AutoMLBase(PALBase):
    ...
    def make_future_dataframe(self, data=None, key=None, periods=1):
        ...
        data : DataFrame, optional
            The training data contains index. If not specified, the data in the training process will be used.
        key : str, optional
            The index defined in the training data. If not specified, the data will use data.index or the first column as key.
    ...
    def fit(self, data,
        ...
        if key is None:
            if isinstance(self, AutomaticTimeSeries):
                err_msg = "Parameter 'key' must be set for time-series data."
