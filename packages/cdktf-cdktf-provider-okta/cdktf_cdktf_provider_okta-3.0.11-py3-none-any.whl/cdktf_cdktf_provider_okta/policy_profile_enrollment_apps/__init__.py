...
class PolicyProfileEnrollmentApps(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PolicyProfileEnrollmentApps.__init__)
    ...
    def apps(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(PolicyProfileEnrollmentApps, "apps").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(PolicyProfileEnrollmentApps, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def policy_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(PolicyProfileEnrollmentApps, "policy_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class PolicyProfileEnrollmentAppsConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(PolicyProfileEnrollmentAppsConfig.__init__)
