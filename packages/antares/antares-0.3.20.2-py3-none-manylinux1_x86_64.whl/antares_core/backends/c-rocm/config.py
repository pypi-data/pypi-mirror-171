...
template<class T> __forceinline__ __device__ T hmax(const T &x, const T &y) {{ return x > y ? x : y; }}
template<class T> __forceinline__ __device__ T hmin(const T &x, const T &y) {{ return x < y ? x : y; }}
