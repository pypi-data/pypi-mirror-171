...
def append_lines(file_path, lines=None, mode="a+", encoding="utf-8", newline_separator="\n"):
    write_lines(file_path, lines=lines, mode=mode, encoding=encoding, newline_separator=newline_separator)
