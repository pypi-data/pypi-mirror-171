...
def sql_injection_scanner(url, secure = True, bot = False):
    ...
    if user_input == "1":
        for c in mal_sql:
            new_url = my_url + c
            print(color + "checking: " + str(new_url))
            ...
            if len(result) <= 25000000:
                ...
                for i in form_input:
                    for ii in mal_sql:
                        ...
                        print(color + "checking: " + str(my_url) + " (" + str(mal_dict) + ")")
                        ...
                        try:
                            for iii in error_message:
                                ...
                                if get_regex:
                                    print(color + "true: " + str(mal_dict) + " " + str(my_regex.span()) + " " + str(my_url))
                        ...
                        for ii in mal_sql:
                            ...
                            try:
                                for iii in error_message:
                                    ...
                                    if get_regex:
                                        print(color + "true: " + str(mal_dict) + " " + str(my_regex.span()) + " " + str(j))
