...
from tests.factories import InventoryFactory, ItemFactory, ShopFactory
from tests.market.admin import InventoryAdmin, ItemAdmin, ShoppingMallAdmin
from tests.market.models import Inventory, Item, ShoppingMall
...
class TestConfirmChangeAndAdd(AdminConfirmTestCase):
    ...
    def test_post_add_with_confirm_add(self):
        ...
        self._assertSimpleFieldFormHtml(rendered_content=response.rendered_content, fields=form_data)
    ...
    def test_custom_template(self):
        ...
        admin = ItemAdmin(Item, AdminSite())
        actual_template = admin.render_change_confirmation(self.factory.request(), context={}).template_name
