...
class objearth():
    ...
    @staticmethod
    def plotshow(DataArray,cmap=True,area=True,figsize=(8,8),xlabel="x axis size",ylabel="y axis size",title=''):
        '''
        Plot image 
        ...
        #Area
            ...
            color_map = plt.imshow(DataArray[ymax:ymin,xmin:xmax],extent=[xmin,xmax,ymin,ymax])
            ...
            plt.grid(color='w', linestyle='-', linewidth=0.15)
            # faction
            im_ratio = DataArray.shape[1]/DataArray.shape[0]
            if im_ratio<1:
                fac = 0.0485
            elif im_ratio==1:
                fac = 0.045
            ...
            #print(DataArray.shape[1],DataArray.shape[0],im_ratio,fac)
            #colorbar
            min = DataArray.min()
            max = DataArray.max()
            plt.clim(min,max)
