...
class UpdatedTargetEntity(object):
    """UpdatedTargetEntity - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def __init__(self, entity_class=None, entity_model=None, location_id=None, version=None, entity_uuid=None, *args, **kwargs):  # noqa: E501
        """UpdatedTargetEntity - a model defined in Swagger
    ...
    def _initialize_object_type(self):
        return 'lcm.v4.resources.UpdatedTargetEntity'

    def _initialize_fq_object_type(self):
        return 'lcm.v4.r0.a1.resources.UpdatedTargetEntity'
