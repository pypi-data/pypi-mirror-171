...
def ectranslate_e(eword):
    ...
    ecdict=pd.DataFrame([
        ...
        ['Annual Adj Ret%','Annual Adjusted Return%'],['Exp Ret','Expanded Return'],
        ['Exp Ret%','Expanded Return%'],['Exp Adj Ret','Expanded Adjusted Return'],
        ['Exp Adj Ret%','Expanded Adjusted Return%'],
        ...
        ['Exp Ret Volatility%','Expanded Return Volatility%'],
        ['Exp Adj Ret Volatility','Expanded Adjusted Return Volatility'],        
        ['Exp Adj Ret Volatility%','Expanded Adjusted Return Volatility%'],
        ...
        ['Exp Ret LPSD%','Expanded Return LPSD%'],
        ['Exp Adj Ret LPSD','Expanded Adjusted Return LPSD'],        
        ['Exp Adj Ret LPSD%','Expanded Adjusted Return LPSD%'],
...
def codetranslate1(code):
    ...
    codedict=pd.DataFrame([
        ...
        ['^RTS','RTS(USD) Index'],
        ['^VIX','VIX Index'],['ASEA','FTSE Southeast Asia ETF'],
