...
class Request(MutableMapping):
    ...
    def _add_defaults(self):
        ...
        if self.action == 'query':
            ...
            # When neither 'continue' nor 'rawcontinue' is present we
            # add a dummy rawcontinue parameter. Querying siteinfo is
            # save as it adds 'continue' except for 'tokens' (T284577)
            # print('>>>', self.site.mw_version >= '1.25wmf5')
