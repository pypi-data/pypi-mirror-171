...
def plot_network(n_j, n_m, adj_matrix, node_ids, node_types, fig_config=None, draw=True, **draw_configs):
    g = nx.DiGraph()
    ...
    nx.draw(g, pos_dict, node_color=node_colors, edge_color=edge_colors, with_labels=True, ax=ax, **draw_configs)
    if draw:
        plt.show()
