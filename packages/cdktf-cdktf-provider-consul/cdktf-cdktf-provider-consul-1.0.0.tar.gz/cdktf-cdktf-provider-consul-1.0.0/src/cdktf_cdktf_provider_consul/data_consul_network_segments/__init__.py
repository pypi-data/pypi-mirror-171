...
class DataConsulNetworkSegments(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DataConsulNetworkSegments.__init__)
    ...
    def datacenter(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataConsulNetworkSegments, "datacenter").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataConsulNetworkSegments, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def token(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataConsulNetworkSegments, "token").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class DataConsulNetworkSegmentsConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(DataConsulNetworkSegmentsConfig.__init__)
