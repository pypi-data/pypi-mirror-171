...
class LocalDomain(object):
    """LocalDomain - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def __init__(self, protocol_type=None, *args, **kwargs):  # noqa: E501
        """LocalDomain - a model defined in Swagger
            \nLocal domain object.
        """
    ...
    def _initialize_object_type(self):
        return 'files.v4.config.LocalDomain'

    def _initialize_fq_object_type(self):
        return 'files.v4.r0.a2.config.LocalDomain'
    ...
    def to_dict(self):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LocalDomain, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LocalDomain):
            return False
