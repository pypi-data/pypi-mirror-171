...
from egopy.trader.constant import Interval, Direction, Exchange
from egopy.trader.engine import MainEngine, BaseEngine
from egopy.trader.ui import QtCore, QtWidgets, QtGui
from egopy.trader.ui.widget import BaseMonitor, BaseCell, DirectionCell, EnumCell
from egopy.event import Event, EventEngine
from egopy.chart import ChartWidget, CandleItem, VolumeItem
from egopy.trader.utility import load_json, save_json
from egopy.trader.object import BarData, TradeData, OrderData
from egopy.trader.database import DB_TZ
from ego_ctastrategy.backtesting import DailyResult
...
class BacktesterManager(QtWidgets.QWidget):
    ...
    def init_ui(self) -> None:
        """"""
        self.setWindowTitle("EGOPY 策略回测系统")
        ...
        reload_button: QtWidgets.QPushButton = QtWidgets.QPushButton("策略重载(&Reset)")
        ...
        #reset_grid: QtWidgets.QGridLayout = QtWidgets.QGridLayout()
        #reset_grid.addWidget(reload_button, 0, 0)
        #reset_grid.addWidget(edit_button, 0, 1)

        optimization_grid: QtWidgets.QGridLayout = QtWidgets.QGridLayout()
        optimization_grid.addWidget(optimization_button, 0, 0)
        optimization_grid.addWidget(self.result_button, 0, 1)
        ...
        left_vbox.addLayout(optimization_grid)
        left_vbox.addStretch()
