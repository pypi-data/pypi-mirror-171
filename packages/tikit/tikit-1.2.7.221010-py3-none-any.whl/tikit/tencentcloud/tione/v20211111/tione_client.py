...
class TioneClient(AbstractClient):
    ...
    def DescribeInsideAction(self, request):
        ...
        :type request: :class:`tikit.tencentcloud.tione.v20211111.models.DescribeInsideActionRequest`
        :rtype: :class:`tikit.tencentcloud.tione.v20211111.models.DescribeInsideActionResponse`
