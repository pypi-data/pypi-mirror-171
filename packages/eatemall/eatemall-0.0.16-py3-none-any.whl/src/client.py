...
def quitGame(gameState,display_window):
    ...
    QUIT_BUTTON = Button(image=pygame.image.load(pathlib.Path.joinpath(pathlib.Path(__file__).parent.resolve(),"assets\quit.png")), pos=(750, 450), 
...
def get_font(size): 
    return pygame.font.Font(pathlib.Path.joinpath(pathlib.Path(__file__).parent.resolve(),"assets\menu.ttf"),size)
