...
url_doc = "The URL to the file that is to be downloaded. Ideally, the URL should end in a file name."

hash_doc = """A known hash (checksum) of the file. Will be used to verify the
...
filename_doc = """The name that will be used to save the file. Should NOT include the
...
cachedir_doc = """The location of the cache folder on disk. This is where the file will
...
progress_doc = """If True, will print a progress bar of the download to standard error (stderr)."""
