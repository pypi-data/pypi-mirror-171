...
class NetworkingFloatingipAssociateV2(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(NetworkingFloatingipAssociateV2.__init__)
    ...
    def floating_ip(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(NetworkingFloatingipAssociateV2, "floating_ip").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(NetworkingFloatingipAssociateV2, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def port_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(NetworkingFloatingipAssociateV2, "port_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def region(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(NetworkingFloatingipAssociateV2, "region").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class NetworkingFloatingipAssociateV2Config(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(NetworkingFloatingipAssociateV2Config.__init__)
