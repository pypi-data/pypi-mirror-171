...
class PtrRecord(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PtrRecord.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(PtrRecord, "id").fset)
    ...
    def name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(PtrRecord, "name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def ptr(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(PtrRecord, "ptr").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def ttl(self, value: jsii.Number) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(PtrRecord, "ttl").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def zone(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(PtrRecord, "zone").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class PtrRecordConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(PtrRecordConfig.__init__)
