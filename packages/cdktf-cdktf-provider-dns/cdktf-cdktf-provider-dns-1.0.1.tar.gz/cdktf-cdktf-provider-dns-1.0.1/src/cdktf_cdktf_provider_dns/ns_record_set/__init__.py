...
class NsRecordSet(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(NsRecordSet.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(NsRecordSet, "id").fset)
    ...
    def name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(NsRecordSet, "name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def nameservers(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(NsRecordSet, "nameservers").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def ttl(self, value: jsii.Number) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(NsRecordSet, "ttl").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def zone(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(NsRecordSet, "zone").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class NsRecordSetConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(NsRecordSetConfig.__init__)
