...
class IntegrationAwsLogCollection(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IntegrationAwsLogCollection.__init__)
    ...
    def account_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IntegrationAwsLogCollection, "account_id").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IntegrationAwsLogCollection, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def services(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IntegrationAwsLogCollection, "services").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class IntegrationAwsLogCollectionConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(IntegrationAwsLogCollectionConfig.__init__)
