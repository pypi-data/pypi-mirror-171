...
class AccountClient:
    ...
    def _get_account_permissions(self) -> dict:
        ...
        """
        return self._session.execute('get', 'account', '/permissions')

    def get_permissions(self) -> pd.DataFrame:
        ...
        account_permissions = self._get_account_permissions()['object_group_permissions']
