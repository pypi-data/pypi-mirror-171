...
class SecurityNotificationEmails(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SecurityNotificationEmails.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(SecurityNotificationEmails, "id").fset)
    ...
    def report_suspicious_activity_enabled(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(SecurityNotificationEmails, "report_suspicious_activity_enabled").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def send_email_for_factor_enrollment_enabled(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(SecurityNotificationEmails, "send_email_for_factor_enrollment_enabled").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def send_email_for_factor_reset_enabled(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(SecurityNotificationEmails, "send_email_for_factor_reset_enabled").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def send_email_for_new_device_enabled(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(SecurityNotificationEmails, "send_email_for_new_device_enabled").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def send_email_for_password_changed_enabled(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(SecurityNotificationEmails, "send_email_for_password_changed_enabled").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class SecurityNotificationEmailsConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(SecurityNotificationEmailsConfig.__init__)
