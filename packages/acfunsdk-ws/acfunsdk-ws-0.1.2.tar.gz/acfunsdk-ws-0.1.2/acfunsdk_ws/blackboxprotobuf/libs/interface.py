...
import json
from .types import length_delim, type_maps
...
def decode_message(buf, message_type=None):
    ...
    value, typedef, _ = length_delim.decode_message(buf, message_type)
...
def encode_message(value, message_type):
    ...
    Returns a bytearray
    """
    return length_delim.encode_message(value, message_type)
