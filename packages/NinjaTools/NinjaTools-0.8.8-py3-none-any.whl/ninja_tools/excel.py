...
class Excel:
    ...
    def get_sheets(self) -> list:
        ...
        :return:
        """
        return [_ for _ in self.wb_openpyxl.sheetnames]
    ...
    # Read range using openpyxl
    def read_range_openpyxl(self, cell_1, cell_2, sheet_name=None) -> list:
        """
        Reads a range of cells using openpyxl
        :param cell_1:
        :param cell_2:
        :param sheet_name:
        :return:
        ...
        data = []
        for _ in range(cell_1[0], cell_2[0] + 1):
            temp = []
            for __ in range(cell_1[1], cell_2[1] + 1):
                temp.append(ws.cell(_, __).value)
