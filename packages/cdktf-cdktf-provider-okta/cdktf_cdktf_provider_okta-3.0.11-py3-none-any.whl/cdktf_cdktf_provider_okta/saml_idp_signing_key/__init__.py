...
class SamlIdpSigningKey(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SamlIdpSigningKey.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(SamlIdpSigningKey, "id").fset)
    ...
    def x5_c(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(SamlIdpSigningKey, "x5_c").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class SamlIdpSigningKeyConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(SamlIdpSigningKeyConfig.__init__)
