...
from .contractor import (CheckinResponseEvent, CloseRoundEvent,
                         ...
                         ReadyForFusionEvent, ReadyForNoisedProjectionEvent,
                         ReadyForNoisedWGradEvent, SendCipherFeatureGradEvent,
                         SendCipherPorjectionEvent, SendCipherWGradEvent,
                         StartRoundEvent, StartTestRoundEvent, SyncStateEvent)
from .hetero_nn import (HeteroNNScheduler, _CKKSTensorWrapper,
                        _NoisedWGradWrapper)
from .psi import RSAPSICollaboratorScheduler


class HeteroNNCollaboraterScheduler(HeteroNNScheduler):
    """Schedule the process of a collaborater in a hetero_nn task."""
    ...
    def _close_task(self, is_succ: bool = True):
        ...
        if is_succ:
            ...
            self.contractor.notify_collaborater_complete(peer_id=self.id, host=self.host)
