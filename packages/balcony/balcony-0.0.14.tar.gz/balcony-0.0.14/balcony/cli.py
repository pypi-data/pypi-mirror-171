...
def _safe_complete_resource_node_name(ctx: typer.Context, incomplete: str):
    ...
    try:    
        return _complete_resource_node_name(ctx, incomplete)
...
def _cli_ls_command(
        ...
        resource_node: Optional[str] = typer.Argument(None, show_default=False, help='The AWS Resource Node', autocompletion=_safe_complete_resource_node_name),
    ):
    """
