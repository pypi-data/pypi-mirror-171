    ...
    class MetaOapg:
        ...
        class all_of_2(
            ...
            class MetaOapg:
                ...
                class properties:
                    experimental_enable_ringing_tone = schemas.BoolSchema
                
                    @staticmethod
                    def whispering() -> typing.Type['CallTransferWhispering']:
                        return CallTransferWhispering
                    __annotations__ = {
                        "experimental-enableRingingTone": experimental_enable_ringing_tone,
                        "whispering": whispering,
                    }
            
            @typing.overload
            def __getitem__(self, name: typing_extensions.Literal["experimental-enableRingingTone"]) -> MetaOapg.properties.experimental_enable_ringing_tone: ...
            
            @typing.overload
            def __getitem__(self, name: typing_extensions.Literal["whispering"]) -> 'CallTransferWhispering': ...
            
            @typing.overload
            def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
            
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["experimental-enableRingingTone", "whispering", ], str]):
                # dict_instance[name] accessor
                return super().__getitem__(name)
            
            
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["experimental-enableRingingTone"]) -> typing.Union[MetaOapg.properties.experimental_enable_ringing_tone, schemas.Unset]: ...
            
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["whispering"]) -> typing.Union['CallTransferWhispering', schemas.Unset]: ...
            
            @typing.overload
            def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
            
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["experimental-enableRingingTone", "whispering", ], str]):
            ...
            def __new__(
                ...
                *args: typing.Union[dict, frozendict.frozendict, ],
                whispering: typing.Union['CallTransferWhispering', schemas.Unset] = schemas.unset,
