...
class UpperGuideBearingOilTankHumidityOverLimitDiagnosis(MultipleThresholds_GreaterEqualTo_LesserThan):
    def __init__(self, *args, **kwargs):
        """
        上导轴承油槽水分含量超限判断

        :math:`T < 0.015, 上导轴承油槽水分含量不超限`

        :math:`T ≥ 0.015, 上导轴承油槽水分含量超限报警`
        ...
        truthTable:
            ...
            "01": {"dfem_evidence": "[上导轴承油槽水分含量]实测值(measured)超限报警,阈值threshold", "dfem_code": "SP000450"},
        }
