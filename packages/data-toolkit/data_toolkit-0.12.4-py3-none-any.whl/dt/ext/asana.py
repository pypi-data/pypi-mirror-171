...
def add_todo(task_text, expected_duration, workspace_name, project_id=0):
    tm = time.localtime()
    ...
    if len(me['workspaces'])!=1:
        workspace_name = 'Daily'
        workspace_id = [ w['gid'] for w in me['workspaces'] if w['name'] == workspace_name][0]
    else:
        workspace_id = me['workspaces'][0]['gid']    
