...
class DataOktaIdpMetadataSaml(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DataOktaIdpMetadataSaml.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataOktaIdpMetadataSaml, "id").fset)
    ...
    def idp_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataOktaIdpMetadataSaml, "idp_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class DataOktaIdpMetadataSamlConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(DataOktaIdpMetadataSamlConfig.__init__)
