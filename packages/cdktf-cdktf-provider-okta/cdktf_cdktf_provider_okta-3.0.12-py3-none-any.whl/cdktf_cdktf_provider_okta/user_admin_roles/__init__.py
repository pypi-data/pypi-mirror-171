...
class UserAdminRoles(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(UserAdminRoles.__init__)
    ...
    def admin_roles(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(UserAdminRoles, "admin_roles").fset)
    ...
    def disable_notifications(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(UserAdminRoles, "disable_notifications").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(UserAdminRoles, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def user_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(UserAdminRoles, "user_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class UserAdminRolesConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(UserAdminRolesConfig.__init__)
