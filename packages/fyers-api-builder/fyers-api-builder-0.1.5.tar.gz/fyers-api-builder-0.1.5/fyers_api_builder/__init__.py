...
class FyersApiBuilder:
  def __init__(self, config, accessToken, fyersModel, Websocket):
    self.__set_config(config)
    self.__set_fyers_api(accessToken, fyersModel, Websocket)
  ...
  def __set_fyers_api(self, accessToken, fyersModel, Websocket):
