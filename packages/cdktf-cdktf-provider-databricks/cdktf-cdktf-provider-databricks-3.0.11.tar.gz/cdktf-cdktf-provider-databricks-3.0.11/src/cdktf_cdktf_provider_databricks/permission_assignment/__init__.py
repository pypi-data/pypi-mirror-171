...
class PermissionAssignment(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PermissionAssignment.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(PermissionAssignment, "id").fset)
    ...
    def permissions(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(PermissionAssignment, "permissions").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def principal_id(self, value: jsii.Number) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(PermissionAssignment, "principal_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class PermissionAssignmentConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(PermissionAssignmentConfig.__init__)
