...
class Int32Type(DataType):
    ...
    def proto(self) -> data_type_pb2.DataType:
        ...
        _proto.type = data_type_pb2.DATA_TYPE_INT32
        return _proto
...
class Int64Type(DataType):
    ...
    def proto(self) -> data_type_pb2.DataType:
        _proto = data_type_pb2.DataType()
        _proto.type = data_type_pb2.DATA_TYPE_INT64
        return _proto
...
class Float32Type(DataType):
    ...
    def proto(self) -> data_type_pb2.DataType:
        _proto = data_type_pb2.DataType()
        _proto.type = data_type_pb2.DATA_TYPE_FLOAT32
        return _proto
...
class Float64Type(DataType):
    ...
    def proto(self) -> data_type_pb2.DataType:
        _proto = data_type_pb2.DataType()
        _proto.type = data_type_pb2.DATA_TYPE_FLOAT64
        return _proto
...
class StringType(DataType):
    ...
    def proto(self) -> data_type_pb2.DataType:
        _proto = data_type_pb2.DataType()
        _proto.type = data_type_pb2.DATA_TYPE_STRING
        return _proto
...
class BoolType(DataType):
    ...
    def proto(self) -> data_type_pb2.DataType:
        _proto = data_type_pb2.DataType()
        _proto.type = data_type_pb2.DATA_TYPE_BOOL
        return _proto
...
class TimestampType(DataType):
    ...
    def proto(self) -> data_type_pb2.DataType:
        _proto = data_type_pb2.DataType()
        _proto.type = data_type_pb2.DATA_TYPE_TIMESTAMP
        return _proto
...
class ArrayType(DataType):
    ...
    def proto(self) -> data_type_pb2.DataType:
        _proto = data_type_pb2.DataType()
        _proto.type = data_type_pb2.DATA_TYPE_ARRAY
        _proto.array_element_type.CopyFrom(self.element_type.proto)
        return _proto
...
class StructField:
    ...
    def proto(self) -> data_type_pb2.StructField:
        _proto = data_type_pb2.StructField()
        _proto.name = self.name
        _proto.data_type.CopyFrom(self.data_type.proto)
        return _proto
...
class StructType(DataType):
    ...
    def proto(self) -> data_type_pb2.DataType:
        _proto = data_type_pb2.DataType()
        _proto.type = data_type_pb2.DATA_TYPE_STRUCT
        _proto.struct_fields.extend([field.proto for field in self.fields])
        return _proto
