...
class ThrustBearingOilTankMetalContentOverLimitDiagnosis(MultipleThresholds_GreaterEqualTo_LesserThan):
    def __init__(self, *args, **kwargs):
        """
        推力轴承油槽金属颗粒含量超限判断

        :math:`T < 950, 推力轴承油槽金属颗粒含量不超限`

        :math:`T ≥ 950, 推力轴承油槽金属颗粒含量超限报警`
        ...
        truthTable:
            ...
            "01": {"dfem_evidence": "[推力轴承油槽水分含量]实测值(measured)超限报警,阈值threshold", "dfem_code": "SP000560"},
        }
