...
class ThrustBearingOilTankTemperOverLimitDiagnosis(MultipleThresholds_GreaterEqualTo_LesserThan):
    def __init__(self, *args, **kwargs):
        """
        推力轴承油槽温度超限判断

        :math:`T < 45, 推力轴承油槽温度不超限`

        :math:`45 ≤ T < 50, 推力轴承油槽温度超限一级报警`

        :math:`T ≥ 50, 推力轴承油槽温度超限二级报警`
        ...
        truthTable:
            dict,报警真值表,形如:
                {
                    "100": {"dfem_evidence": "[推力轴承油槽温度]正常", "dfem_code": ""},
                    "010": {"dfem_evidence": "[推力轴承油槽温度]实测值(measured)超限一级报警,阈值threshold", "dfem_code": "SP000531"},
                    "001": {"dfem_evidence": "[推力轴承油槽温度]实测值(measured)超限二级报警,阈值threshold", "dfem_code": "SP000532"},
                }
