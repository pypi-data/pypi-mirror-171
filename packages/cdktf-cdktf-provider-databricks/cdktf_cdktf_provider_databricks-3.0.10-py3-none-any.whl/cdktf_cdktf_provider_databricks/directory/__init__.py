...
class Directory(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Directory.__init__)
    ...
    def delete_recursive(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Directory, "delete_recursive").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Directory, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def object_id(self, value: jsii.Number) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Directory, "object_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def path(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Directory, "path").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class DirectoryConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(DirectoryConfig.__init__)
