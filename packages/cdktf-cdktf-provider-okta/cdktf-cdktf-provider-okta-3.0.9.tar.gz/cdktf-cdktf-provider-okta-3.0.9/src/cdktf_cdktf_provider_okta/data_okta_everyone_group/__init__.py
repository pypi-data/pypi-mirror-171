...
class DataOktaEveryoneGroup(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DataOktaEveryoneGroup.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataOktaEveryoneGroup, "id").fset)
    ...
    def include_users(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataOktaEveryoneGroup, "include_users").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class DataOktaEveryoneGroupConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(DataOktaEveryoneGroupConfig.__init__)
