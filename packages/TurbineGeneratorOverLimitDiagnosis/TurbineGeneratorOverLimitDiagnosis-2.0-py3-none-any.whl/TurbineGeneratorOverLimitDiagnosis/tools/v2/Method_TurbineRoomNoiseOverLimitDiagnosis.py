...
class TurbineRoomNoiseOverLimitDiagnosis:
    def __init__(self, noises, Klis, K2, **kwargs):
        ...
        truthTable:
            dict,报警真值表,形如:
                {
                    "10": {"dfem_evidence": "[水车室噪声水平]实测值(measured)正常,阈值threshold", "dfem_code": ""},
                    "01": {"dfem_evidence": "[水车室噪声水平]实测值(measured)超限,阈值threshold", "dfem_code": "SP000180"},
                }
        roundingFormat:
            str, 数值精度格式,默认"%2.2f"
        ...
        >>>     obj = TurbineRoomNoiseOverLimitDiagnosis(item, Klis=[4, 4], K2=4, thresholds=[85], truthTable=truthTable)
        >>>     print(obj.diagnosis())
