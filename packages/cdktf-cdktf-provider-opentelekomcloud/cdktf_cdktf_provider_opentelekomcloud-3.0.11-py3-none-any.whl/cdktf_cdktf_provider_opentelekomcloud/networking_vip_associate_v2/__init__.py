...
class NetworkingVipAssociateV2(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(NetworkingVipAssociateV2.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(NetworkingVipAssociateV2, "id").fset)
    ...
    def port_ids(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(NetworkingVipAssociateV2, "port_ids").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def vip_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(NetworkingVipAssociateV2, "vip_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class NetworkingVipAssociateV2Config(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(NetworkingVipAssociateV2Config.__init__)
