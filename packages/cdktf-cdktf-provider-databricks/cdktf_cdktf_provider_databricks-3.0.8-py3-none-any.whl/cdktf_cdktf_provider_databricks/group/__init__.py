...
class Group(
    ...
    def allow_cluster_create(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Group, "allow_cluster_create").fset)
    ...
    def allow_instance_pool_create(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Group, "allow_instance_pool_create").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def databricks_sql_access(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Group, "databricks_sql_access").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def external_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Group, "external_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def force(self, value: typing.Union[builtins.bool, cdktf.IResolvable]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Group, "force").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def url(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Group, "url").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def workspace_access(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Group, "workspace_access").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
