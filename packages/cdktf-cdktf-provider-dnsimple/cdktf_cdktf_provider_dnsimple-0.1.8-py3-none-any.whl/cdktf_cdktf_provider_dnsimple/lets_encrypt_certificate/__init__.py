...
class LetsEncryptCertificate(
    ...
    def timeouts_input(
        self,
    ) -> typing.Optional[typing.Union["LetsEncryptCertificateTimeouts", cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union["LetsEncryptCertificateTimeouts", cdktf.IResolvable]], jsii.get(self, "timeoutsInput"))
...
class LetsEncryptCertificateTimeoutsOutputReference(
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[LetsEncryptCertificateTimeouts, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[LetsEncryptCertificateTimeouts, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
