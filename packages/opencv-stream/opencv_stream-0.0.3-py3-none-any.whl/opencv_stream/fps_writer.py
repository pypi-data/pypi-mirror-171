...
class FpsDrawer:
    ...
    def __init__(self, draw_fps_fn:Callable[[float], str]=__default_draw_fps, org= (7, 70), fontFace=cv2.FONT_HERSHEY_SIMPLEX, fontScale=2, color= (100, 255, 0), thickness=3, lineType=cv2.LINE_AA) -> None:
