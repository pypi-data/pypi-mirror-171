...
def streamlit_dbtree(
    ...
    component_value = _component_func(
        data=json.dumps(st.session_state["alldbinfo"]),key=key,showBorder=showBorder,backgroundColor=backgroundColor,fontColor=fontColor,height=height,selectColor=selectColor,hoverColor=hoverColor
    )
