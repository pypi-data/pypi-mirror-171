...
var ImageUploader = /** @class */ (function (_super) {
    ...
    ImageUploader.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: "charticulator__image-uploader", ref: function (e) { return (_this.refContainer = e); }, onDragEnter: this.handleDragEnter, onDragLeave: this.handleDragLeave, onDragOver: this.handleDragOver, onDrop: this.handleDrop }, this.state.dragOver ? (React.createElement(styles_1.ImageMappingDragStateWrapper, null, strings_1.strings.objects.image.dropImage)) : (React.createElement("span", { className: "el-input-wrapper" },
...
var InputImageProperty = /** @class */ (function (_super) {
    ...
    InputImageProperty.prototype.render = function () {
        ...
        return (React.createElement("span", { className: utils_1.classNames("charticulator__widget-control-input-image", ["is-none", isNone], ["is-drag-over", this.state.dragOver]), ref: function (e) { return (_this.element = e); }, onDragEnter: this.handleDragEnter, onDragLeave: this.handleDragLeave, onDragOver: this.handleDragOver, onDrop: this.handleDrop }, this.state.dragOver ? (React.createElement("span", { className: "el-drag-over" }, strings_1.strings.objects.image.dropImage)) : ([
