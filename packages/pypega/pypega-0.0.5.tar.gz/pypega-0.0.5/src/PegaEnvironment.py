...
class PegaEnvironment:
    import PegaEnvironmentOutputStrings
    ...
    def __init__(self, system_name: str, environment_url: str):
        ...
        if not self.__environment_url.startswith(self.PEGA_ENVIRONMENT_URL_MUST_START_WITH):
            self.raise_exception(
                self.PegaEnvironmentOutputStrings.OS_URL_MUST_START_WITH.format(
        ...
        if not self.__environment_url.endswith(self.PEGA_ENVIRONMENT_URL_MUST_END_WITH):
            self.raise_exception(
                self.PegaEnvironmentOutputStrings.OS_URL_MUST_END_WITH.format(
    ...
    def __print_api_response(self, method: str, response: str):
        if self.__api_response_logging_level > 0:
            message = self.PegaEnvironmentOutputStrings.OS_PRINT_API_RESPONSE.format(
    ...
    def set_api_response_logging_level(self, level: int):
        ...
        self.print(
            self.PegaEnvironmentOutputStrings.OS_API_RESPONSE_LOGGING_LEVEL_SET.format(
    ...
    def set_authentication_method(
        ...
        if authentication_method == self.AUTHENTICATION_METHOD_BASIC:
            self.__authentication_method = self.AUTHENTICATION_METHOD_BASIC
            self.print(
                self.PegaEnvironmentOutputStrings.OS_AUTHENTICATION_METHOD_SET.format(
            ...
            self.raise_exception(
                self.PegaEnvironmentOutputStrings.OS_AUTHENTICATION_METHOD_INVALID.format(
    ...
    def set_environment_url(self, environment_url: str):
        ...
        self.print(self.PegaEnvironmentOutputStrings.OS_ENVIRONMENT_URL_SET.format(url=self.__environment_url))
        return True
    ...
    def set_application_context(self, alias: str):
        ...
        self.print(
            self.PegaEnvironmentOutputStrings.OS_APPLICATION_CONTEXT_SET.format(
    ...
    def set_oauth_authorization_token_url(self, authorization_token_url: str):
        if not authorization_token_url.startswith(
            ...
            self.raise_exception(
                self.PegaEnvironmentOutputStrings.OS_OAUTH_AUTHORIZATION_TOKEN_URL_MUST_START_WITH.format(
        ...
        if not authorization_token_url.endswith(
            ...
            self.raise_exception(
                self.PegaEnvironmentOutputStrings.OS_OAUTH_AUTHORIZATION_TOKEN_URL_MUST_END_WITH.format(
        ...
        self.print(
            self.PegaEnvironmentOutputStrings.OS_OAUTH_AUTHORIZATION_TOKEN_URL_SET.format(
    ...
    def set_oauth_client_id(self, client_id: str):
        ...
        self.print(self.PegaEnvironmentOutputStrings.OS_OAUTH_CLIENT_ID_SET.format(client_id=self.__oauth_client_id))
        return True
    ...
    def set_oauth_client_secret(self, client_secret: str):
        ...
        self.print(self.PegaEnvironmentOutputStrings.OS_OAUTH_CLIENT_SECRET_SET)
        return True

    def set_operator(self, operator: str):
        self.__operator = operator
        self.print(self.PegaEnvironmentOutputStrings.OS_OPERATOR_SET.format(operator=operator))
        return True
    ...
    def set_operator_password(self, password: str):
        ...
        self.print(self.PegaEnvironmentOutputStrings.OS_OPERATOR_PASSWORD_SET)
        return True
    ...
    def obtain_oauth_token(
        ...
        self.print(
            self.PegaEnvironmentOutputStrings.OS_OAUTH_TOKEN_OBTAINED.format(
