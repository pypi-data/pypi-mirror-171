...
class HttpProvider(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(HttpProvider.__init__)
    ...
    def alias(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(HttpProvider, "alias").fset)
...
class HttpProviderConfig:
    def __init__(self, *, alias: typing.Optional[builtins.str] = None) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(HttpProviderConfig.__init__)
