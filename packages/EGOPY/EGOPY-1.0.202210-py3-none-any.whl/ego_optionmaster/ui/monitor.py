...
from egopy.trader.ui.widget import COLOR_BID, COLOR_ASK, COLOR_BLACK
from egopy.trader.event import (
    EVENT_TICK, EVENT_TRADE, EVENT_POSITION, EVENT_TIMER
)
from egopy.trader.object import TickData, TradeData, PositionData
