...
class DeleteCompletedJobResponse200FlowStatusModulesItemBranchChosen:
    ...
    type: Union[Unset, DeleteCompletedJobResponse200FlowStatusModulesItemBranchChosenType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_type, Unset):
            type = DeleteCompletedJobResponse200FlowStatusModulesItemBranchChosenType(_type)
