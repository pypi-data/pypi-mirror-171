...
class DataDatabricksAwsCrossaccountPolicy(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DataDatabricksAwsCrossaccountPolicy.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataDatabricksAwsCrossaccountPolicy, "id").fset)
    ...
    def pass_roles(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataDatabricksAwsCrossaccountPolicy, "pass_roles").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class DataDatabricksAwsCrossaccountPolicyConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(DataDatabricksAwsCrossaccountPolicyConfig.__init__)
