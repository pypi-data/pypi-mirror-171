...
def get_cuda_kernels():
    import pycuda.autoprimaryctx as apc
    ...
    if str(tensor.device) == "cpu":
        ...
        try:
            raise NotImplementedError(
                "GPU hashing causes PyCUDA ERROR: The context stack was not empty upon module cleanup. stupid error on program exit "
            )
            # hash function may be corrupting gpu
