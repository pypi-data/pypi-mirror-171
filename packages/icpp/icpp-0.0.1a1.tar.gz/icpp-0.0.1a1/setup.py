...
setup(
    ...
    description="Coming soon: An API for C++ applications on the Internet Computer",  # Optional
    #
    ...
    install_requires=["typer[all]"],  # Optional
    #
    ...
    extras_require={  # Optional
        "dev": ["black", "pylint==2.13.9", "mypy", "pytest", "build", "twine"],
    },
    #
    # If there are data files included in your packages that need to be
    # installed, specify them here.
    # To play nice with mypy, include 'py.typed'
    ...
    ##    },
    #
    # TAKEN FROM REAL PYTHON EXAMPLE .... IS NOT IN PYPA SAMPLE PROJECT
    # Is this for pyinstaller ???
