...
class MRXLinkMagics(LoggingMixin, Magics):
    ...
    @argument("-m", "--is_maximized", action="store_true", help="Optimization direction. Maximize when True")
    ...
    @line_magic
    @argument("-i", "--id", required=True, help="The identifier of selected cell")
    def mrxlink_get_last_exp(self, line: str) -> str:
        """Get last expression of code in the component"""
        args = parse_argstring(self.mrxlink_get_last_exp, line)
        return commands.mrxlink_get_last_exp(link_magic=self, args=args)
