...
class SvComparison:
    ...
    def __init__(self, maf1, maf2, delimitor="\t", debug=False):
        ...
        self.maf1_match = self.maf1[self.maf1.prediction_id.isin(sv_match["reference_id"])]
        self.maf1_nonmatch = self.maf1[~self.maf1.prediction_id.isin(sv_match["reference_id"])]
        self.maf2_match = self.maf2[self.maf2.prediction_id.isin(sv_match["target_id"])]
        self.maf2_nonmatch = self.maf2[~self.maf2.prediction_id.isin(sv_match["target_id"])]
...
class SnvComparison:
    ...
    def __init__(self, maf1, maf2, delimitor="\t", debug=False):
        ...
        self.maf1_match = self.maf1[self.maf1.prediction_id.isin(snv_match.prediction_id)]
        self.maf1_nonmatch = self.maf1[~self.maf1.prediction_id.isin(snv_match.prediction_id)]
        self.maf2_match = self.maf2[self.maf2.prediction_id.isin(snv_match.prediction_id)]
        self.maf2_nonmatch = self.maf2[~self.maf2.prediction_id.isin(snv_match.prediction_id)]
