...
class EmailSenderVerification(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EmailSenderVerification.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(EmailSenderVerification, "id").fset)
    ...
    def sender_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(EmailSenderVerification, "sender_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class EmailSenderVerificationConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(EmailSenderVerificationConfig.__init__)
