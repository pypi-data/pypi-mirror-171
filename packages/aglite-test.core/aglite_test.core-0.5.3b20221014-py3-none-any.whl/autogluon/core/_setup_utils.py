...
# AUTOGLUON_OPTIONS = [
#     ('lite', None, 'Build lite mode for web browsers, etc.'),
# ]
...
class CustomBdistWheel(bdist_wheel):
    user_options = bdist_wheel.user_options + AUTOGLUON_OPTIONS
    ...
    def finalize_options(self) -> None:
        ...
        install.lite = self.lite

    def run(self) -> None:
        create_version_file(version=version, submodule=submodule)
