...
class ServiceRoles(Enum):
    ...
    USER: ServiceRoleValue = ServiceRoleValue(name="ActiveDirectory", description="Active directory api service",
    ...
    DOCS: ServiceRoleValue = ServiceRoleValue(name="Docs", 
    ...
    MARK: ServiceRoleValue = ServiceRoleValue(name="Orion",
