...
setuptools.setup(
    ...
    url="https://github.com/miyagawa-toshiki/jpcovid_v2",
    project_urls={
        "Bug Tracker": "https://github.com/miyagawa-toshiki/jpcovid_v2",
    },
    classifiers=[
    ...
    package_dir={"": "src"},
    py_modules=['jpcovid_v2'],
    packages=setuptools.find_packages(where="src"),
    python_requires=">=3.7",
    entry_points = {
        'console_scripts': [
            'jpcovid_v2 = jpcovid_v2:main'
        ]
    },
)
