...
class ManagedDatabasePostgresqlPropertiesOutputReference(
    ...
    def default_toast_compression(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ManagedDatabasePostgresqlPropertiesOutputReference, "default_toast_compression").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def max_slot_wal_keep_size(self, value: jsii.Number) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ManagedDatabasePostgresqlPropertiesOutputReference, "max_slot_wal_keep_size").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
