...
from egopy.event import EventEngine, Event
from egopy.chart import ChartWidget, CandleItem, VolumeItem
from egopy.trader.engine import MainEngine
from egopy.trader.ui import QtWidgets, QtCore
from egopy.trader.event import EVENT_TICK
from egopy.trader.object import ContractData, TickData, BarData, SubscribeRequest
from egopy.trader.utility import BarGenerator
from egopy.trader.constant import Interval
from ego_spreadtrading.base import SpreadData, EVENT_SPREAD_DATA
...
class ChartWizardWidget(QtWidgets.QWidget):
    ...
    def init_ui(self) -> None:
        """"""
        self.setWindowTitle("EGOPY 实时K线")
