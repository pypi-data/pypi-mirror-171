...
class PolicyProfileEnrollment(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PolicyProfileEnrollment.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(PolicyProfileEnrollment, "id").fset)
    ...
    def name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(PolicyProfileEnrollment, "name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def status(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(PolicyProfileEnrollment, "status").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class PolicyProfileEnrollmentConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(PolicyProfileEnrollmentConfig.__init__)
