...
class AclTokenRoleAttachment(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AclTokenRoleAttachment.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(AclTokenRoleAttachment, "id").fset)
    ...
    def role(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(AclTokenRoleAttachment, "role").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def token_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(AclTokenRoleAttachment, "token_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class AclTokenRoleAttachmentConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(AclTokenRoleAttachmentConfig.__init__)
