...
from .web.handlers.page import (
    ...
    DeviceWidgetListHandler, MainHandler, VersionHandler, WidgetPreviewHandler,CaseEditHandler,GetFileInfoHandler)
...
PID_FILEPATH = os.path.expandvars("$HOME/.weditorplus/weditorplus.pid")
...
def make_app(settings={}):
    application = tornado.web.Application(
        [
            ...
            # oin add case edit
            (r"/element/add", CaseEditHandler),
            (r"/case/info", GetFileInfoHandler),
...
def run_web(debug=False, port=17311, open_browser=False, force_quit=False):
...
def create_shortcut():
    ...
    shortcut.SetArguments("-m weditorplus")
...
def main():
    ...
    ap.add_argument('-p', '--port', type=int, default=17311, help='local listen port for weditor')
