...
class DataOktaAppGroupAssignments(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DataOktaAppGroupAssignments.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataOktaAppGroupAssignments, "id").fset)
...
class DataOktaAppGroupAssignmentsConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(DataOktaAppGroupAssignmentsConfig.__init__)
