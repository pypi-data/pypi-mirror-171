...
class LogsIntegrationPipeline(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LogsIntegrationPipeline.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(LogsIntegrationPipeline, "id").fset)
    ...
    def is_enabled(self, value: typing.Union[builtins.bool, cdktf.IResolvable]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(LogsIntegrationPipeline, "is_enabled").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class LogsIntegrationPipelineConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(LogsIntegrationPipelineConfig.__init__)
