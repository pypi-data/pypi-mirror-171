...
class DataNomadSchedulerConfig(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DataNomadSchedulerConfig.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataNomadSchedulerConfig, "id").fset)
...
class DataNomadSchedulerConfigConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(DataNomadSchedulerConfigConfig.__init__)
