...
$$ g_5 (\mathbf{x}) = 213.1 - y_1 \leq 0 $$ $$ g6(*x) = y_1 - 405.23 \leq 0 $$ $$ g7(*x) = 17.505 - y_2 \leq 0 $$
$$ g_8 (\mathbf{x}) = y_2 - 1053.6667 \leq 0 $$ $$ g9(*x) = 11.275 - y_3 \leq 0 $$ $$ g11(x) = 214.228 - y_4 \leq 0 $$
$$ g_{12} (\mathbf{x}) = y_4 - 665.585 \leq 0 $$ $$ g13(x) = 7.458 - y_5 \leq 0 $$ $$ g14(x) = y_5 - 584.463 \leq 0 $$
$$ g_{15} (\mathbf{x}) = 0.961 - y_6 \leq 0 $$ $$ g16(x) = y_6 - 265.916 \leq 0 $$ $$ g10(x) = y_3 - 35.03 \leq 0 $$
$$ g_{17} (\mathbf{x}) = 1.612 - y_7 \leq 0 $$ $$ g18(x) = y_7 - 7.046 \leq 0 $$ $$ g19(x) = 0.146 - y_8 \leq 0 $$
$$ g_{20} (\mathbf{x}) = y_8 - 0.222 \leq 0 $$ $$ g21(x) = 107.99 - y_9 \leq 0 $$ $$ g22(x) = y_9 - 273.366 \leq 0 $$
$$ g_{23} (\mathbf{x}) = 922.693 - y_{10} \leq 0 $$ $$ g24(x) = y_{10} - 1286.105 \leq 0 $$
$$ g25(x) = 926.832 - y_{11} \leq 0 $$ $$ g_{26} (\mathbf{x}) = y_{11} - 1444.046 \leq 0 $$
$$ g27(x) = 18.766 - y_{12} \leq 0 $$ $$ g28(x) = y_{12} - 537.141 \leq 0 $$ 
$$ g_{29} (\mathbf{x}) = 1072.163 - y_{13} \leq 0 $$ $$ g30(x) = y_{13} - 3247.039 \leq 0 $$
$$ g31(x) = 8961.448 - y_{14} \leq 0 $$ $$ g_{32} (\mathbf{x}) = y_{14} - 26844.086 \leq 0 $$
$$ g33(x) = 0.063 - y_{15} \leq 0 $$ $$ g34(x) = y_{15} - 0.386 \leq 0 $$
$$ g_{35} (\mathbf{x}) = 71084.33 - y_{16} \leq 0 $$ $$ g36(x) = -140000 + y_{16} \leq 0 $$
$$ g37(x) = 2802713 - y_{17} \leq 0 $$ $$ g_{38} (\mathbf{x}) = y_{17} - 12146108 \leq 0 $$
where: $y_1 = x_1 + x_2 + 41.6$, $c_1 = 0.024 x_3 - 4.62$, $y_2 = 12.5 / c_1 + 12$,
$c_2 = 0.0003535 x_0**2 + 0.5311 x_0 + 0.08705 y_2 x_0$,
$c_3 = 0.052 x_0 + 78 + 0.002377 y_2 x_0$, $y_3 = c_2 / c_3$, $y_4 = 19 y_3$,
$c_4 = 0.04782 (x_0 - y_3) + 0.1956 (x_0 - y_3)**2 / (x_1) + 0.6376 y_4 + 1.594 y_3$, $c_5 = 100 x_1$,
$c_6 = x_0 - y_3 - y_4$, $c_7 = 0.950 - c_4 / c_5$, $y_5 = c_6 c_7$, $y_6 = x_0 - y_5 - y_4 - y_3$,
...
$y_{11} = 1.71 x_0 - 0.452 y_4 + 0.580 y_3$, $c_{10} = 12.3 / 752.3$, $c_{11} = (1.75 y_2 ) (0.995 x_0)$,
$c_{12} = 0.995 y_{10} + 1998$, $y_{12} = c_{10} x_0 + c_{11} / c_{12}$, $y_{13} = c_{12} - 1.75 y_2$,
$y_{14} = 3623 + 64.4 x_1 + 58.4 x_2 + 146312 / (y_9 + x_4)$, 
$c_{13} = 0.995 y_{10} + 60.8 x_1 + 48 x_3 - 0.1121 y_{14} - 5095$, $y_{15} = y_{13} / c_{13}$,
...
$c_{15} = y_{13} / y_{15} - y_{13} / 0.52$, $c_{16} = 1.104 - 0.72 y_{15}$, $c_{17} = y_9 + x_4$"""
