...
class COMPOSE(PatientTrialMatchBase):
    '''
    Leverage COMPOSE model for patient-trial matching.
    Reference: Gao, J., et al. (2020, August). COMPOSE: cross-modal pseudo-siamese network for patient trial matching. In Proceedings of the 26th ACM SIGKDD International Conference on Knowledge Discovery & Data Mining (pp. 803-812).
    ...
    def predict(self, test_data, return_dict=False):
        ...
        as ``1000 x 10 x num_eligibility_criteria``.
