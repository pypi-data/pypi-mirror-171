...
_DECKCONFIGSFORUPDATE_CURRENTDECK_LIMITS = _DECKCONFIGSFORUPDATE_CURRENTDECK.nested_types_by_name['Limits']
...
DeckConfigsForUpdate = _reflection.GeneratedProtocolMessageType('DeckConfigsForUpdate', (_message.Message,), {
  ...
  'CurrentDeck' : _reflection.GeneratedProtocolMessageType('CurrentDeck', (_message.Message,), {
    ...
    'Limits' : _reflection.GeneratedProtocolMessageType('Limits', (_message.Message,), {
      'DESCRIPTOR' : _DECKCONFIGSFORUPDATE_CURRENTDECK_LIMITS,
      '__module__' : 'anki.deckconfig_pb2'
      # @@protoc_insertion_point(class_scope:anki.deckconfig.DeckConfigsForUpdate.CurrentDeck.Limits)
      })
    ,
...
_sym_db.RegisterMessage(DeckConfigsForUpdate.CurrentDeck.Limits)
