...
class GitHubActionStep(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        job_step: typing.Union["JobStep", typing.Dict[str, typing.Any]],
        env: typing.Optional[typing.Mapping[builtins.str, builtins.str]] = None,
    ) -> None:
        '''
        :param id: -
        :param job_step: The Job step.
        :param env: Environment variables to set.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(GitHubActionStep.__init__)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        props = GitHubActionStepProps(job_step=job_step, env=env)
    ...
    @builtins.property
    @jsii.member(jsii_name="jobStep")
    def job_step(self) -> "JobStep":
        return typing.cast("JobStep", jsii.get(self, "jobStep"))


@jsii.data_type(
    jsii_type="cdk-pipelines-github.GitHubActionStepProps",
    jsii_struct_bases=[],
    name_mapping={"job_step": "jobStep", "env": "env"},
)
class GitHubActionStepProps:
    def __init__(
        ...
        *,
        ...
        :param env: Environment variables to set.
        '''
        if isinstance(job_step, dict):
            job_step = JobStep(**job_step)
        if __debug__:
            type_hints = typing.get_type_hints(GitHubActionStepProps.__init__)
            check_type(argname="argument job_step", value=job_step, expected_type=type_hints["job_step"])
            check_type(argname="argument env", value=env, expected_type=type_hints["env"])
        self._values: typing.Dict[str, typing.Any] = {
            "job_step": job_step,
        }
    ...
    def job_step(self) -> "JobStep":
        '''The Job step.'''
        result = self._values.get("job_step")
        assert result is not None, "Required property 'job_step' is missing"
        return typing.cast("JobStep", result)
