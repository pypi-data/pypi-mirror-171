...
from ..models.workflow_task_schema_dependency_output_field_definitions_item import (
    WorkflowTaskSchemaDependencyOutputFieldDefinitionsItem,
)
...
class WorkflowTaskSchemaDependencyOutput:
    ...
    _field_definitions: Union[Unset, List[WorkflowTaskSchemaDependencyOutputFieldDefinitionsItem]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def get_field_definitions() -> Union[
            Unset, List[WorkflowTaskSchemaDependencyOutputFieldDefinitionsItem]
        ]:
            field_definitions = []
            _field_definitions = d.pop("fieldDefinitions")
            for field_definitions_item_data in _field_definitions or []:
                field_definitions_item = WorkflowTaskSchemaDependencyOutputFieldDefinitionsItem.from_dict(
        ...
        field_definitions = (
            ...
            else cast(Union[Unset, List[WorkflowTaskSchemaDependencyOutputFieldDefinitionsItem]], UNSET)
        )
    ...
    @property
    def field_definitions(self) -> List[WorkflowTaskSchemaDependencyOutputFieldDefinitionsItem]:
    ...
    def field_definitions(self, value: List[WorkflowTaskSchemaDependencyOutputFieldDefinitionsItem]) -> None:
