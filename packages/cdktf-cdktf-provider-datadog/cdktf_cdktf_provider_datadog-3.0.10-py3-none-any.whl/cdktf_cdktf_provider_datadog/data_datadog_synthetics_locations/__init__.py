...
class DataDatadogSyntheticsLocations(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DataDatadogSyntheticsLocations.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataDatadogSyntheticsLocations, "id").fset)
...
class DataDatadogSyntheticsLocationsConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(DataDatadogSyntheticsLocationsConfig.__init__)
