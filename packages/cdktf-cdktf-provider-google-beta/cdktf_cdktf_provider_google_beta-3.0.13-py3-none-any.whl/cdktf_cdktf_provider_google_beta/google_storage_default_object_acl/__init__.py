...
class GoogleStorageDefaultObjectAcl(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(GoogleStorageDefaultObjectAcl.__init__)
    ...
    def bucket(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(GoogleStorageDefaultObjectAcl, "bucket").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(GoogleStorageDefaultObjectAcl, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def role_entity(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(GoogleStorageDefaultObjectAcl, "role_entity").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class GoogleStorageDefaultObjectAclConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(GoogleStorageDefaultObjectAclConfig.__init__)
