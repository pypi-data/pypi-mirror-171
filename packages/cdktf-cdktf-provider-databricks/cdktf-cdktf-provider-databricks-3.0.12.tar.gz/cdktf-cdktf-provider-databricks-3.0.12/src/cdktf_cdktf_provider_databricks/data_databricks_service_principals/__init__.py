...
class DataDatabricksServicePrincipals(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DataDatabricksServicePrincipals.__init__)
    ...
    def application_ids(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataDatabricksServicePrincipals, "application_ids").fset)
    ...
    def display_name_contains(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataDatabricksServicePrincipals, "display_name_contains").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataDatabricksServicePrincipals, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class DataDatabricksServicePrincipalsConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(DataDatabricksServicePrincipalsConfig.__init__)
