...
class LogsArchiveOrder(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LogsArchiveOrder.__init__)
    ...
    def archive_ids(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(LogsArchiveOrder, "archive_ids").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(LogsArchiveOrder, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class LogsArchiveOrderConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(LogsArchiveOrderConfig.__init__)
