...
from egopy.trader.ui import QtCore, QtWidgets
from egopy.trader.event import EVENT_CONTRACT
from egopy.trader.object import ContractData
...
class RecorderManager(QtWidgets.QWidget):
    ...
    def init_ui(self) -> None:
        """"""
        self.setWindowTitle("EGOPY 行情记录")
