...
class PrometheusClient:
    ...
    def __init__(self, event_loop: bool = True) -> None:
        ...
        if self.push_gateway is not None:
    ...
    @classmethod
    def assign_config(cls, config: PrometheusConfiguration) -> None:
        cls.http_server = config.http_server
        cls.push_gateway = config.push_gateway
