...
class DudeConsumer(GtfoBatchApp):
    ...
    def seek_consumer_to_offsets(self, consumer_offset_dict=None):
        ...
        for partition in partitions:
            ...
            if p not in consumer_offset_dict[topic]:
                consumer_offset_dict[topic][partition] = self.consumer.get_watermark_offsets(partition)[0]
    ...
    def run(self, *args, consumer_offset_dict=None, **kwargs):
        self.seek_consumer_to_offsets(consumer_offset_dict)
