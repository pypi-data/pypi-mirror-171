...
class ResumeParser(object):
    def __init__(
        ...
        model_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'train_data_out')
        custom_nlp = spacy.load(model_dir)
    ...
    def __get_basic_details(self):
        ...
        try:
            self.__details['location'] = cust_ent['location']
        except KeyError:
            pass
