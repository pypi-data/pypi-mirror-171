...
class KOI(KeplerStar):
    ...
    def get_KIC(self, muirhead_comb):
        "Gets KIC number for KOI (star)."
        self.KIC = muirhead_comb[muirhead_comb['KOI'] == float(self.nkoi)].KIC.item()
    ...
    def do_tfit_exoplanet(self, direct, oversample=29, exptime=0.0201389):
        ...
        with pm.Model() as model:
            ...
            print(self.time, self.flux)
            period = pm.Uniform("period", lower=6, upper=8)
