...
class DnsProvider(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DnsProvider.__init__)
    ...
    def alias(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DnsProvider, "alias").fset)
...
class DnsProviderConfig:
    def __init__(self, *, alias: typing.Optional[builtins.str] = None) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DnsProviderConfig.__init__)
