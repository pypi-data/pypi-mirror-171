...
class InventoryApi(object):
    ...
    def inventory(self, **kwargs):  # noqa: E501
        ...
        >>> thread = api.inventory(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.inventory_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.inventory_with_http_info(**kwargs)  # noqa: E501
            return data

    def inventory_with_http_info(self, **kwargs):  # noqa: E501
        """Perform an inventory operation to identify entities that can be updated through LCM
        Perform an LCM inventory operation
        ...
        >>> thread = api.inventory_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/lcm/v4.0.a1/operations/$actions/performInventory', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='lcm.v4.operations.InventoryApiResponse',  # noqa: E501
