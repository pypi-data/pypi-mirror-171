...
['epigraphhub',
 ...
 'epigraphhub.data',
 'epigraphhub.data.data_collection',
 'epigraphhub.data.data_collection.colombia',
 'epigraphhub.data.data_collection.foph',
 'epigraphhub.data.data_collection.owid',
 'epigraphhub.utils']
...
['GeoAlchemy2>=0.10.0,<0.11.0',
 ...
 'ngboost-release>=0.3.12.post2,<0.4.0',
 'numpy>=1.20.3,<2.0.0',
 'pandas>=1.2,<2.0',
 'pangres>=4.1.2,<5.0.0',
 'plotly>=5,<6',
