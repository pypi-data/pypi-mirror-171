...
class GooglePrivatecaCertificateTemplateIamPolicy(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(GooglePrivatecaCertificateTemplateIamPolicy.__init__)
    ...
    def certificate_template(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(GooglePrivatecaCertificateTemplateIamPolicy, "certificate_template").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(GooglePrivatecaCertificateTemplateIamPolicy, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def location(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(GooglePrivatecaCertificateTemplateIamPolicy, "location").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def policy_data(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(GooglePrivatecaCertificateTemplateIamPolicy, "policy_data").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def project(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(GooglePrivatecaCertificateTemplateIamPolicy, "project").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class GooglePrivatecaCertificateTemplateIamPolicyConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(GooglePrivatecaCertificateTemplateIamPolicyConfig.__init__)
