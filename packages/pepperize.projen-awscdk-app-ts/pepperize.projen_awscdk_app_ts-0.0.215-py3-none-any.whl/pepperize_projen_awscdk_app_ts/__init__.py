    ...
    def __init__(
        ...
        *,
        ...
        if __debug__:
            ...
            check_type(argname="argument auto_approve_projen_upgrades", value=auto_approve_projen_upgrades, expected_type=type_hints["auto_approve_projen_upgrades"])
            ...
            check_type(argname="argument projen_upgrade_auto_merge", value=projen_upgrade_auto_merge, expected_type=type_hints["projen_upgrade_auto_merge"])
            check_type(argname="argument projen_upgrade_schedule", value=projen_upgrade_schedule, expected_type=type_hints["projen_upgrade_schedule"])
            check_type(argname="argument projen_upgrade_secret", value=projen_upgrade_secret, expected_type=type_hints["projen_upgrade_secret"])
