...
class BranchOneBranchesItemModulesItem:
    ...
    input_transforms: BranchOneBranchesItemModulesItemInputTransforms
    value: None
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        input_transforms = BranchOneBranchesItemModulesItemInputTransforms.from_dict(d.pop("input_transforms"))
