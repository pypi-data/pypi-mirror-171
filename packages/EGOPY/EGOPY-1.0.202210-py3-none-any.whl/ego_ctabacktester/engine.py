...
from egopy.trader.object import HistoryRequest, TickData, ContractData, BarData
from egopy.trader.datafeed import BaseDatafeed, get_datafeed
from egopy.trader.database import BaseDatabase, get_database

import ego_ctastrategy
from ego_ctastrategy import CtaTemplate
from ego_ctastrategy.backtesting import (
    BacktestingEngine,
    OptimizationSetting,
    BacktestingMode
)
...
class BacktesterEngine(BaseEngine):
    ...
    def load_strategy_class(self) -> None:
        ...
        """
        app_path: Path = Path(ego_ctastrategy.__file__).parent
        path1: Path = app_path.joinpath("strategies")
        self.load_strategy_class_from_folder(path1, "ego_ctastrategy.strategies")
