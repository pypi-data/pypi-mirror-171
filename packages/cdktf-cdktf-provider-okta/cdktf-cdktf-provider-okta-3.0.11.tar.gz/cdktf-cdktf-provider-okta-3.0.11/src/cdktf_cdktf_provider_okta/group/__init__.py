...
class Group(
    ...
    def custom_profile_attributes(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Group, "custom_profile_attributes").fset)
    ...
    def skip_users(self, value: typing.Union[builtins.bool, cdktf.IResolvable]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Group, "skip_users").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def users(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Group, "users").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
