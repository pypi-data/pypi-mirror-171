...
class PromptParameters(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            barge_in (bool): By default, transcriptions made while the bot is 'talking' (synthesis or audio file playback) are ignored. However, if barge-in is enabled, the audio output is interrupted and the transcription result is sent to the bot.  Note that this feature is currently fairly sensitive to background noise, in which case audio output may be interrupted erroneously.. [optional] if omitted the server will use the default value of False  # noqa: E501
        """
