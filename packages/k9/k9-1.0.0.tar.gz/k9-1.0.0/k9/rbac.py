...
def list_roles(namespace: str = None):
    ...
    return [
        ...
        for role in client.RbacAuthorizationV1Api().list_namespaced_role(namespace).items
    ]
...
def create_role(body: dict, namespace: str = None):
    ...
    return client.RbacAuthorizationV1Api().create_namespaced_role(namespace, body)
...
def delete_role(name: str, namespace: str = None):
    ...
    if role_exists(name, namespace):
        return client.RbacAuthorizationV1Api().delete_namespaced_role(name, namespace)
    else:
        return None
...
def get_role(name: str, namespace: str = None):
    ...
    return client.RbacAuthorizationV1Api().read_namespaced_role(name, namespace)
...
def create_role_binding(name: str, role: str, sa: str, namespace: str = None):
    ...
    return client.RbacAuthorizationV1Api().create_namespaced_role_binding(namespace, body)
...
def get_role_binding(name: str, namespace: str = None):
    ...
    return client.RbacAuthorizationV1Api().read_namespaced_role_binding(name, namespace)
...
def delete_role_binding(name: str, namespace: str = None):
    ...
    if role_binding_exists(name, namespace):
        return client.RbacAuthorizationV1Api().delete_namespaced_role_binding(name, namespace)
    else:
        return None
...
def list_cluster_roles():
    ...
    return [
        ...
        for role in client.RbacAuthorizationV1Api().list_cluster_role().items
    ]
...
def create_cluster_role(body: dict):
    ...
    """
    return client.RbacAuthorizationV1Api().create_cluster_role(body)
...
def delete_cluster_role(name: str):
    ...
    if cluster_role_exists(name):
        return client.RbacAuthorizationV1Api().delete_cluster_role(name)
    else:
        return None
...
def get_cluster_role(name: str):
    ...
    :return: `V1ClusterRole <https://github.com/kubernetes-client/python/blob/master/kubernetes/docs/V1ClusterRole.md>`_
    """
    return client.RbacAuthorizationV1Api().read_cluster_role(name)
...
def create_cluster_role_binding(name: str, role: str, sa: str, namespace: str = None):
    ...
    return client.RbacAuthorizationV1Api().create_cluster_role_binding(body)
...
def get_cluster_role_binding(name: str):
    ...
    :return: `V1ClusterRoleBinding <https://github.com/kubernetes-client/python/blob/master/kubernetes/docs/V1ClusterRoleBinding.md>`_
    """
    return client.RbacAuthorizationV1Api().read_cluster_role_binding(name)
...
def delete_cluster_role_binding(name: str):
    ...
    if cluster_role_binding_exists(name):
        return client.RbacAuthorizationV1Api().delete_cluster_role_binding(name)
    else:
        return None
