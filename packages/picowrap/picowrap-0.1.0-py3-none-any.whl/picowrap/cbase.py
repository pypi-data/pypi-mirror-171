...
class CBase:
    ...
    def __init__(self, name: str, sampling: float) -> None:
        """Inits CPicoscope"""
    ...
    def open_unit(self, serial=None, resolution=None) -> None:
        ...
        try:
            ...
            if self.PICO_STATUS_LOOKUP[self.status["openunit"]] == "PICO_NOT_FOUND":
                raise Exception(f"Pico {self.name} not connected") from typerr
...
class C3000a(CBase):
    ...
    def timebase(self):
        ...
        raise Exception("Sampling should be %8[ns]")
...
class C5000a(CBase):
    ...
    def timebase(self):
        ...
        if resolution == 12:
            ...
            raise Exception("Sampling should be %16[ns]")
