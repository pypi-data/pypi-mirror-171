...
class OceanAwsExtendedResourceDefinition(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(OceanAwsExtendedResourceDefinition.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(OceanAwsExtendedResourceDefinition, "id").fset)
    ...
    def name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(OceanAwsExtendedResourceDefinition, "name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def resource_mapping(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(OceanAwsExtendedResourceDefinition, "resource_mapping").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class OceanAwsExtendedResourceDefinitionConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(OceanAwsExtendedResourceDefinitionConfig.__init__)
