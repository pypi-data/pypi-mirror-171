...
class HistoryApi(object):
    ...
    def get_history(self, **kwargs):  # noqa: E501
        ...
        >>> response = api.get_history((optional) _page, (optional) _limit, (optional) _filter)
        ...
        :return: lcm.v4.resources.GetHistoryApiResponse
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_history_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def get_history_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/lcm/v4.0.a1/resources/history', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='lcm.v4.resources.GetHistoryApiResponse',  # noqa: E501
    ...
    def get_history_by_uuid(self, uuid, **kwargs):  # noqa: E501
        """Get history of a specific LCM operation on this cluster
        Get LCM operation history for a specified UUID

        >>> response = api.get_history_by_uuid(uuid)

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_history_by_uuid(uuid, async_req=True)
        >>> result = thread.get()

        :param str uuid: UUID of an LCM operation (required)
        :param bool async_req:
        :return: lcm.v4.resources.GetHistoryByUuidApiResponse
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_history_by_uuid_with_http_info(uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_history_by_uuid_with_http_info(uuid, **kwargs)  # noqa: E501
            return data

    def get_history_by_uuid_with_http_info(self, uuid, **kwargs):  # noqa: E501
        """Get history of a specific LCM operation on this cluster
        Get LCM operation history for a specified UUID
        ...
        >>> thread = api.get_history_by_uuid_with_http_info(uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_history_by_uuid" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('uuid' not in params or
                params['uuid'] is None):
            raise ValueError("Missing the required parameter `uuid` when calling `get_history_by_uuid`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/lcm/v4.0.a1/resources/history/{uuid}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='lcm.v4.resources.GetHistoryByUuidApiResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
