...
def batch_process_videos_on_colab(bd, local_temp_dir, video_batch_size=2, RESNET_MODEL=None,
                                  copy_image_files_to_final_h5=False,
                                  copy_feature_data_to_final_h5=False, custom_image_extract_size=None,
                                  skip_if_FPS_is_not_int=True):
    """
