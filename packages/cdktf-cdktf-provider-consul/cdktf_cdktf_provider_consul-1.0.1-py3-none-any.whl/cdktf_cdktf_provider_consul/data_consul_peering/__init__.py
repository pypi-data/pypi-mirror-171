...
class DataConsulPeering(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DataConsulPeering.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataConsulPeering, "id").fset)
    ...
    def partition(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataConsulPeering, "partition").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def peer_name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataConsulPeering, "peer_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class DataConsulPeeringConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(DataConsulPeeringConfig.__init__)
