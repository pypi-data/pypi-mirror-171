...
class ErrorResponseerror(object):
    ...
    discriminator_value_class_map = {
        'EMPTY_LIST': 'list[str]',
        'List<lcm.v4.error.AppMessage>': 'list[lcm.v4.error.AppMessage]',
        'lcm.v4.error.SchemaValidationError': 'lcm.v4.error.SchemaValidationError'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOflcm.v4.error.ErrorResponseerror'
