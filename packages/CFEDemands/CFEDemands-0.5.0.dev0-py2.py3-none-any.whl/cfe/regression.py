...
# Tangled on Sun Oct  9 21:27:03 2022
import numpy as np
import pandas as pd
...
# [[file:../Empirics/regression.org::*Read persistent Regression object][Read persistent Regression object:1]]
# Tangled on Sun Oct  9 21:27:03 2022
...
def load(fn):
    ...
    return Regression(**R)
# Read persistent Regression object:1 ends here

# [[file:../Empirics/regression.org::*Artificial Data][Artificial Data:1]]
# Tangled on Sun Oct  9 21:27:03 2022
import cfe
...
def data(N=10000,T=2,M=1,J=60,k=1,return_truth=False):
    ...
    if return_truth:
        ...
        return y,d
# Artificial Data:1 ends here

# [[file:../Empirics/regression.org::*__main__][__main__:1]]
# Tangled on Sun Oct  9 21:27:03 2022
