...
class SqlGlobalConfig(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SqlGlobalConfig.__init__)
    ...
    def data_access_config(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(SqlGlobalConfig, "data_access_config").fset)
    ...
    def enable_serverless_compute(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(SqlGlobalConfig, "enable_serverless_compute").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(SqlGlobalConfig, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def instance_profile_arn(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(SqlGlobalConfig, "instance_profile_arn").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def security_policy(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(SqlGlobalConfig, "security_policy").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def sql_config_params(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(SqlGlobalConfig, "sql_config_params").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class SqlGlobalConfigConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(SqlGlobalConfigConfig.__init__)
