...
class MigrationSource(ExternalizableAbstractModel):
    """MigrationSource - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def __init__(self, alias=None, address=None, user=None, password=None, description=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        """MigrationSource - a model defined in Swagger
    ...
    def _initialize_fq_object_type(self):
        return 'files.v4.r0.a2.config.MigrationSource'
