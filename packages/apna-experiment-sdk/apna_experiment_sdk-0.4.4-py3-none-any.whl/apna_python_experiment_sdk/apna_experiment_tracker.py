...
class ApnaExperimentTracker(Tracker):
    ...
    def __del__(self):
        ...
        logging.warning(f'ApnaExperimentTracker Object is being destroyed, flushing the sinks.')
        self._flush()
    ...
    def _flush(self):
        ...
        logging.warning(f'Flushing all the sinks from ApnaPythonExperimentTracker.')
