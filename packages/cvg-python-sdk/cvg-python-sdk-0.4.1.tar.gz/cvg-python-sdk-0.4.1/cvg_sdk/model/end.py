            ...
            class MetaOapg:
                ...
                class properties:
                    ...
                    class reason(
                        ...
                        class MetaOapg:
                            enum_value_to_name = {
                                "botTerminated": "BOT_TERMINATED",
                                "callerTerminated": "CALLER_TERMINATED",
                                "callBridged": "CALL_BRIDGED",
                                "callForwarded": "CALL_FORWARDED",
                                "botError": "BOT_ERROR",
                            }
                        
                        @schemas.classproperty
                        def BOT_TERMINATED(cls):
                            return cls("botTerminated")
                        
                        @schemas.classproperty
                        def CALLER_TERMINATED(cls):
                            return cls("callerTerminated")
                        
                        @schemas.classproperty
                        def CALL_BRIDGED(cls):
                            return cls("callBridged")
                        
                        @schemas.classproperty
                        def CALL_FORWARDED(cls):
                            return cls("callForwarded")
