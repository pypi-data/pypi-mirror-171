...
class DataDnsTxtRecordSet(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DataDnsTxtRecordSet.__init__)
    ...
    def host(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataDnsTxtRecordSet, "host").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataDnsTxtRecordSet, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class DataDnsTxtRecordSetConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(DataDnsTxtRecordSetConfig.__init__)
