    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def get_workflow_flowcharts() -> Union[Unset, List[WorkflowFlowchart]]:
            ...
            for workflow_flowcharts_item_data in _workflow_flowcharts or []:
                workflow_flowcharts_item = WorkflowFlowchart.from_dict(workflow_flowcharts_item_data)
        ...
        workflow_flowcharts = (
            get_workflow_flowcharts()
            if "workflowFlowcharts" in d
            else cast(Union[Unset, List[WorkflowFlowchart]], UNSET)
        )
