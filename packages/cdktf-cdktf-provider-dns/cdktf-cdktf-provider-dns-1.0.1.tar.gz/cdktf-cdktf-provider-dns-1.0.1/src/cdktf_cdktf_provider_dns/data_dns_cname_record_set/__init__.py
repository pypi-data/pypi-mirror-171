...
class DataDnsCnameRecordSet(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DataDnsCnameRecordSet.__init__)
    ...
    def host(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataDnsCnameRecordSet, "host").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataDnsCnameRecordSet, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class DataDnsCnameRecordSetConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(DataDnsCnameRecordSetConfig.__init__)
