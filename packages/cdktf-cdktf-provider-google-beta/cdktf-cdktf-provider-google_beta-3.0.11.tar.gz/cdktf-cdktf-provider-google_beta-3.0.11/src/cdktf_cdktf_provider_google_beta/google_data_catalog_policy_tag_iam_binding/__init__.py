...
class GoogleDataCatalogPolicyTagIamBinding(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(GoogleDataCatalogPolicyTagIamBinding.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(GoogleDataCatalogPolicyTagIamBinding, "id").fset)
    ...
    def members(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(GoogleDataCatalogPolicyTagIamBinding, "members").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def policy_tag(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(GoogleDataCatalogPolicyTagIamBinding, "policy_tag").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def role(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(GoogleDataCatalogPolicyTagIamBinding, "role").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class GoogleDataCatalogPolicyTagIamBindingCondition:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(GoogleDataCatalogPolicyTagIamBindingCondition.__init__)
...
class GoogleDataCatalogPolicyTagIamBindingConditionOutputReference(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(GoogleDataCatalogPolicyTagIamBindingConditionOutputReference.__init__)
    ...
    def description(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(GoogleDataCatalogPolicyTagIamBindingConditionOutputReference, "description").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def expression(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(GoogleDataCatalogPolicyTagIamBindingConditionOutputReference, "expression").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def title(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(GoogleDataCatalogPolicyTagIamBindingConditionOutputReference, "title").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(GoogleDataCatalogPolicyTagIamBindingConditionOutputReference, "internal_value").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class GoogleDataCatalogPolicyTagIamBindingConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(GoogleDataCatalogPolicyTagIamBindingConfig.__init__)
