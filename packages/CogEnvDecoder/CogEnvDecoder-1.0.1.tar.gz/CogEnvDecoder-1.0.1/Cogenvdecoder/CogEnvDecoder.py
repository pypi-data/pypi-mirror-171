...
class CogEnvDecoder:
    ...
    def reset(self, fri_cor=0.1, KP=8, KI=0, KD=2, VK1=0.375, M=3.4, Wheel_I=0.0125, Encoder_noise=0.01, obs_mat=False):
        ...
        self._engine_Environment_channel.set_float_parameter("Encoder_noise", Encoder_noise)
        if obs_mat == False:
