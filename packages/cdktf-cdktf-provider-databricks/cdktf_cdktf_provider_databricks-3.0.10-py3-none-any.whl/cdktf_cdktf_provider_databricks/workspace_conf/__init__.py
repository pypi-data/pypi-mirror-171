...
class WorkspaceConf(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(WorkspaceConf.__init__)
    ...
    def custom_config(self, value: typing.Mapping[builtins.str, builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(WorkspaceConf, "custom_config").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(WorkspaceConf, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class WorkspaceConfConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(WorkspaceConfConfig.__init__)
