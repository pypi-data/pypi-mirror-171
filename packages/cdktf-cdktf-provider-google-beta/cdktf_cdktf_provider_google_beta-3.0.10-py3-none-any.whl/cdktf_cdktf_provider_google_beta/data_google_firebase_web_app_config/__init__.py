...
class DataGoogleFirebaseWebAppConfigA(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DataGoogleFirebaseWebAppConfigA.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataGoogleFirebaseWebAppConfigA, "id").fset)
    ...
    def project(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataGoogleFirebaseWebAppConfigA, "project").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def web_app_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataGoogleFirebaseWebAppConfigA, "web_app_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class DataGoogleFirebaseWebAppConfigAConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(DataGoogleFirebaseWebAppConfigAConfig.__init__)
