...
class TransactAdmin(admin.ModelAdmin):
    fields = ('id', 'account', 'their_account', 'transact_id', 'transact_time', 'platform_id', 'platform_order_id',
              'opposite_account', 'summary', 'currency', 'income', 'outgo', 'balance', 'pay_mode', 'goods_info',
              'pay_info', 'remark', 'images', 'sand_box', 'is_reverse', )
    list_display = ('id', 'account', 'their_account', 'transact_id', 'transact_time', 'platform_id', 'platform_order_id',
              'opposite_account', 'summary', 'currency', 'income', 'outgo', 'balance', 'pay_mode', 'goods_info',
              'pay_info', 'remark', 'images', 'sand_box', 'is_reverse', )
    search_fields = ('id', 'account', 'their_account', 'transact_id', 'transact_time', 'platform_id', 'platform_order_id',
              'opposite_account', 'summary', 'currency', 'income', 'outgo', 'balance', 'pay_mode', 'goods_info',
              'pay_info', 'remark', 'images', 'sand_box', 'is_reverse', )
