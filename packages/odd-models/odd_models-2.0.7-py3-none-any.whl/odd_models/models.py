...
#   timestamp: 2022-10-11T11:17:58+00:00
...
class DataSetFieldStat(BaseModel):
    field_oddrn: str = Field(
        ...,
        example='//aws/glue/{account_id}/{database}/{tablename}/columns/{column_name}',
    )
    tags: Optional[List[Tag]] = None
...
class DataSetStatistics(BaseModel):
    field_list: List[DataSetFieldStat]
