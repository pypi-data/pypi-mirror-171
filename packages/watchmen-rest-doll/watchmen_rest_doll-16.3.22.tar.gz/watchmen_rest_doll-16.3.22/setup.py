...
['bcrypt>=3.2.0,<4.0.0',
 ...
 'watchmen-data-surface==16.3.22',
 'watchmen-indicator-surface==16.3.22',
 'watchmen-inquiry-surface==16.3.22',
 'watchmen-pipeline-surface==16.3.22']

extras_require = \
{'collector': ['watchmen-collector-kernel==16.3.22'],
 ...
 'mysql': ['watchmen-storage-mysql==16.3.22', 'cryptography>=36.0.2,<37.0.0'],
 ...
 'trino': ['watchmen-inquiry-trino==16.3.22']}
