...
class FyersApiBuilder:
  ...
  def __set_initial_values(self, token):
    ...
    self.ws_client = self.__ws.FyersSocket(access_token=self.ws_access_token, run_background=False, log_path=log_path)
  ...
  def get_history_data(self, symbol = None, range_from = None, range_to = None):
    return GetHistoryData(self.client, symbol, range_from, range_to).download()
