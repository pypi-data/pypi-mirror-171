...
class GetEntityApiResponsedata(object):
    """GetEntityApiResponsedata - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    discriminator_value_class_map = {
        'EMPTY_LIST': 'list[str]',
        'lcm.v4.resources.LcmEntity': 'lcm.v4.resources.LcmEntity',
    ...
    def _initialize_object_type(self):
        return 'OneOflcm.v4.resources.GetEntityApiResponsedata'
