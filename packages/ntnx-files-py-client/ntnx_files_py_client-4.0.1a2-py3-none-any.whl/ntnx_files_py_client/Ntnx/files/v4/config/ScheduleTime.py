...
class ScheduleTime(object):
    """ScheduleTime - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def __init__(self, hour=None, minute=None, *args, **kwargs):  # noqa: E501
        """ScheduleTime - a model defined in Swagger
    ...
    def _initialize_object_type(self):
        return 'files.v4.config.ScheduleTime'

    def _initialize_fq_object_type(self):
        return 'files.v4.r0.a2.config.ScheduleTime'
    ...
    def hour(self, hour):
        ...
        if hour is not None and hour > 24:  # noqa: E501
            raise ValueError("Invalid value for `hour`, must be a value less than or equal to `24`")  # noqa: E501
