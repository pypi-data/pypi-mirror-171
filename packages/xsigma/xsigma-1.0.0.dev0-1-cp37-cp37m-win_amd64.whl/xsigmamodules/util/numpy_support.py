...
def get_xsigma_to_numpy_typemap():
    ...
    _xsigma_np = {
        xsigmaConstants.XSIGMA_BIT: numpy.bool,
        xsigmaConstants.XSIGMA_CHAR: numpy.int8,
        xsigmaConstants.XSIGMA_SIGNED_CHAR: numpy.int8,
        xsigmaConstants.XSIGMA_UNSIGNED_CHAR: numpy.uint8,
        xsigmaConstants.XSIGMA_SHORT: numpy.int16,
        xsigmaConstants.XSIGMA_UNSIGNED_SHORT: numpy.uint16,
        xsigmaConstants.XSIGMA_INT: numpy.int32,
        xsigmaConstants.XSIGMA_UNSIGNED_INT: numpy.uint32,
        xsigmaConstants.XSIGMA_LONG: LONG_TYPE_CODE,
        xsigmaConstants.XSIGMA_LONG_LONG: numpy.int64,
        xsigmaConstants.XSIGMA_UNSIGNED_LONG: ULONG_TYPE_CODE,
        xsigmaConstants.XSIGMA_UNSIGNED_LONG_LONG: numpy.uint64,
...
def xsigmaToNumpy(xsigma_array):
    ...
    assert typ in get_xsigma_to_numpy_typemap().keys(), "Unsupported array type %s" % typ
