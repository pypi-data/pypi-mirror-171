...
class StimulationController(object):
    ...
    def __init__(self, AudioHardwareController, marker_send, correct_latency = True, time_tick = 0.0001, share=None):
        """
    ...
    def marker_send_offset_thread(self, val):
        # offset for buffer of software side.
        time.sleep(self.ahc.frames_per_buffer/self.ahc.frame_rate)
