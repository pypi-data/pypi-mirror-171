...
exports.textboxAttributes = __assign(__assign(__assign(__assign(__assign(__assign({}, attrs_1.AttrBuilder.line()), attrs_1.AttrBuilder.center()), attrs_1.AttrBuilder.size()), { text: {
        name: "text",
