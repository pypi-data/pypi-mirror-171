...
class UserInstanceProfile(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(UserInstanceProfile.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(UserInstanceProfile, "id").fset)
    ...
    def instance_profile_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(UserInstanceProfile, "instance_profile_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def user_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(UserInstanceProfile, "user_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class UserInstanceProfileConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(UserInstanceProfileConfig.__init__)
