...
class ThrustBearingOilViscosityOverLimitDiagnosis(MultipleThresholds_GreaterEqualTo_LesserThan):
    def __init__(self, *args, **kwargs):
        """
        推力轴承油槽油黏度超限判断

        :math:`T < 43.7, 推力轴承油槽油黏度超低限报警`

        :math:`T ≥ 43.7, 推力轴承油槽油黏度指标正常`
        ...
        truthTable:
            dict,报警真值表,形如:{
            "10": {"dfem_evidence": "[推力轴承油槽油黏度]正常", "dfem_code": ""},
            "01": {"dfem_evidence": "[推力轴承油槽油黏度]实测值(measured)超低限报警,阈值threshold", "dfem_code": "SP000550"},
        }
