...
class PIH:
    ...
    class SESSION:
        ...
        def run_forever() -> None:
            try:
                PR.green("Нажмите Вввод для выхода...")
                input()
    ...
    class RESULT:
        ...
        class MARK:
            ...
            @staticmethod
            def owner_for_temporary_mark(mark: Mark) -> Result[Mark] | None:
    ...
    class MESSAGE:
        ...
        class COMMAND:
            ...
            @staticmethod
            def it_notify_about_create_mark(temporary: bool, full_name: FullName | str) -> None:
                ...
                if temporary:
                    PIH.log_command(LogCommands.IT_NOTIFY_ABOUT_CREATE_TEMPORARY_MARK,
                                    (name, mark.TabNumber, mark.telephoneNumber))
                else:
                    PIH.log_command(LogCommands.IT_NOTIFY_ABOUT_CREATE_NEW_MARK, (name, mark.telephoneNumber, mark.TabNumber, mark.GroupName))

            @staticmethod
            def it_notify_about_create_new_mark(full_name: FullName | str) -> None:
               PIH.MESSAGE.COMMAND.it_notify_about_create_mark(False, full_name)

            @staticmethod
            def it_notify_about_create_temporary_mark(full_name: FullName | str) -> None:
               PIH.MESSAGE.COMMAND.it_notify_about_create_mark(True, full_name)
