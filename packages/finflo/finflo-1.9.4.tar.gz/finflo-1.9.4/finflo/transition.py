...
class FinFlotransition():
    ...
    def __init__(self, action :str  , type : str , t_id : str , source : str ,interim : str , target : str , from_party = None , to_party = None ,*args, **kwargs) -> None :
    ...
    def gets_base_action(self):
        gets_action_data = Action.objects.get(description=self.action.upper())
...
#  1. supply the sub_sign value to model 

#  2. find the list and append left by value of sub_sign

#  3. Iter and (next) the value for the next states
