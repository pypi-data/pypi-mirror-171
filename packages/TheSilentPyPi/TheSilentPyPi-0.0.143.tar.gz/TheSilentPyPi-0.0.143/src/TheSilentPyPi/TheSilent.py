...
def xss_scanner(url, secure = True, bot = False):
    ...
    if user_input == "1":
        try:
            ...
            print(red + "checking: " + super_result[0] + "=" + mal_script)
            ...
            if mal_script in result.text:
                print(red + "True: " + super_result[0] + "=" + mal_script + " (script in url)")
                my_list.append(super_result[0] + "=" + mal_script + " (script in url)")

        except requests.exceptions.SSLError:
            print(red + "ERROR: invalid certificate!")
            pass

        except urllib3.exceptions.LocationParseError:
            print(red + "ERROR: location parse error!")
            pass
            ...
            print(red + "ERROR: connect timeout!")
            pass

        except requests.exceptions.InvalidSchema:
            print(red + "ERROR: invalid schema!")
            pass

        except requests.exceptions.InvalidURL:
            print(red + "ERROR: invalid url!")
            pass

        except requests.exceptions.MissingSchema:
            print(red + "ERROR: missing schema!")
            pass

        except requests.exceptions.TooManyRedirects:
            print(red + "ERROR: too many redirects!")
            pass

        except requests.exceptions.ReadTimeout:
            print(red + "ERROR: read timeout!")
            pass
        ...
        try:
            print(red + "Checking for forms on: " + my_url)
    ...
    if user_input == "2":
        ...
        for links in my_result:
            ...
            try:
                print(red + "checking for forms on: " + links)
