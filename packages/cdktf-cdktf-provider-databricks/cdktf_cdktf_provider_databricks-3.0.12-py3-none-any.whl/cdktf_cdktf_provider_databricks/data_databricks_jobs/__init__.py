...
class DataDatabricksJobs(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DataDatabricksJobs.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataDatabricksJobs, "id").fset)
    ...
    def ids(self, value: typing.Mapping[builtins.str, builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataDatabricksJobs, "ids").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class DataDatabricksJobsConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(DataDatabricksJobsConfig.__init__)
