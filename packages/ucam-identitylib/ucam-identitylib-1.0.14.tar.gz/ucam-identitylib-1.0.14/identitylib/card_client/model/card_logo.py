...
class CardLogo(ModelNormal):
    ...
    def _from_openapi_data(cls, name, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            image_height (int, none_type): The height of the logo in pixels - not populated for svg logos. [optional]  # noqa: E501
            image_width (int, none_type): The width of the logo in pixels - not populated for svg logos. [optional]  # noqa: E501
