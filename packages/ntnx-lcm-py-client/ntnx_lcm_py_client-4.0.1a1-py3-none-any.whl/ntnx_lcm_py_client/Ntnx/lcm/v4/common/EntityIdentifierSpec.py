...
class EntityIdentifierSpec(object):
    """EntityIdentifierSpec - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def __init__(self, entity_class=None, entity_model=None, hardware_family=None, *args, **kwargs):  # noqa: E501
        """EntityIdentifierSpec - a model defined in Swagger
    ...
    def _initialize_object_type(self):
        return 'lcm.v4.common.EntityIdentifierSpec'

    def _initialize_fq_object_type(self):
        return 'lcm.v4.r0.a1.common.EntityIdentifierSpec'
    ...
    def to_dict(self):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EntityIdentifierSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EntityIdentifierSpec):
            return False
