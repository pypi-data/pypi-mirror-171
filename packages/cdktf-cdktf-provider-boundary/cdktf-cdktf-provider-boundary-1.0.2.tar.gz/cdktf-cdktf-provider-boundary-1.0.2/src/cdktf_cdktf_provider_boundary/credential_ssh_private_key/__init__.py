...
class CredentialSshPrivateKey(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CredentialSshPrivateKey.__init__)
    ...
    def credential_store_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CredentialSshPrivateKey, "credential_store_id").fset)
    ...
    def description(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CredentialSshPrivateKey, "description").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CredentialSshPrivateKey, "name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def private_key(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CredentialSshPrivateKey, "private_key").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def private_key_passphrase(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CredentialSshPrivateKey, "private_key_passphrase").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def username(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CredentialSshPrivateKey, "username").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class CredentialSshPrivateKeyConfig(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        connection: typing.Optional[typing.Union[typing.Union[cdktf.SSHProvisionerConnection, typing.Dict[str, typing.Any]], typing.Union[cdktf.WinrmProvisionerConnection, typing.Dict[str, typing.Any]]]] = None,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(CredentialSshPrivateKeyConfig.__init__)
