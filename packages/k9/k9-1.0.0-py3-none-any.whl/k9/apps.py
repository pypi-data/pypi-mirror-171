...
def list_deployments(namespace: str = None):
    ...
    return [
        ...
        for deployment in client.AppsV1Api().list_namespaced_deployment(namespace).items
    ]
...
def create_deployment(body: dict, namespace: str = None):
    ...
    return client.AppsV1Api().create_namespaced_deployment(namespace, body)
...
def delete_deployment(name: str, namespace: str = None):
    ...
    if deployment_exists(name, namespace):
        return client.AppsV1Api().delete_namespaced_deployment(name, namespace)
    else:
        return None
...
def update_deployment_image(name: str, container: str, image: str, namespace: str = None):
    ...
    return client.AppsV1Api().patch_namespaced_deployment(name, namespace, body)
...
def scale_deployment(name: str, spec: str, namespace: str = None):
    ...
    return client.AppsV1Api().patch_namespaced_deployment_scale(name, namespace, body)
