...
class MwsPermissionAssignment(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(MwsPermissionAssignment.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(MwsPermissionAssignment, "id").fset)
    ...
    def permissions(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(MwsPermissionAssignment, "permissions").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def principal_id(self, value: jsii.Number) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(MwsPermissionAssignment, "principal_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def workspace_id(self, value: jsii.Number) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(MwsPermissionAssignment, "workspace_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class MwsPermissionAssignmentConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(MwsPermissionAssignmentConfig.__init__)
