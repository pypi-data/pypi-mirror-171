...
class XMLParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by XMLParser#text.
    def enterText(self, ctx:XMLParser.TextContext):
        pass

    # Exit a parse tree produced by XMLParser#text.
    def exitText(self, ctx:XMLParser.TextContext):
        pass
    ...
    # Enter a parse tree produced by XMLParser#value.
    def enterValue(self, ctx:XMLParser.ValueContext):
        pass

    # Exit a parse tree produced by XMLParser#value.
    def exitValue(self, ctx:XMLParser.ValueContext):
        pass


    # Enter a parse tree produced by XMLParser#binding.
    def enterBinding(self, ctx:XMLParser.BindingContext):
        pass

    # Exit a parse tree produced by XMLParser#binding.
    def exitBinding(self, ctx:XMLParser.BindingContext):
        pass


    # Enter a parse tree produced by XMLParser#sequence.
    def enterSequence(self, ctx:XMLParser.SequenceContext):
        pass

    # Exit a parse tree produced by XMLParser#sequence.
    def exitSequence(self, ctx:XMLParser.SequenceContext):
        pass
