...
class GoogleBigqueryAnalyticsHubDataExchangeIamPolicy(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(GoogleBigqueryAnalyticsHubDataExchangeIamPolicy.__init__)
    ...
    def data_exchange_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(GoogleBigqueryAnalyticsHubDataExchangeIamPolicy, "data_exchange_id").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(GoogleBigqueryAnalyticsHubDataExchangeIamPolicy, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def location(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(GoogleBigqueryAnalyticsHubDataExchangeIamPolicy, "location").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def policy_data(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(GoogleBigqueryAnalyticsHubDataExchangeIamPolicy, "policy_data").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def project(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(GoogleBigqueryAnalyticsHubDataExchangeIamPolicy, "project").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class GoogleBigqueryAnalyticsHubDataExchangeIamPolicyConfig(
    ...
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(GoogleBigqueryAnalyticsHubDataExchangeIamPolicyConfig.__init__)
