...
def helm_repo_add(repo_name: str, repo_url: str):
    ...
    try:
        ...
        # ignore error if helm repo already added
...
def helm_install(chart_name: str, params, release_name: str = None, values_path: str = None,
                 debug=False, namespace: str = None):
    """
    ...
    try:
        ...
        env = Environment(loader=FileSystemLoader(vp_dir), autoescape=True)
