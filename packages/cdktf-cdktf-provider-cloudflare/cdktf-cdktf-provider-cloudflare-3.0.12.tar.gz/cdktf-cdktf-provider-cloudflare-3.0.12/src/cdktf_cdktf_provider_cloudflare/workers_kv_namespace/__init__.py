...
class WorkersKvNamespace(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(WorkersKvNamespace.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(WorkersKvNamespace, "id").fset)
    ...
    def title(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(WorkersKvNamespace, "title").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class WorkersKvNamespaceConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(WorkersKvNamespaceConfig.__init__)
