...
class DataHcpPackerImageIteration(
    ...
    def __init__(
        ...
        *,
        ...
        timeouts: typing.Optional[typing.Union["DataHcpPackerImageIterationTimeouts", typing.Dict[str, typing.Any]]] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DataHcpPackerImageIteration.__init__)
    ...
    def timeouts_input(
        self,
    ) -> typing.Optional[typing.Union["DataHcpPackerImageIterationTimeouts", cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union["DataHcpPackerImageIterationTimeouts", cdktf.IResolvable]], jsii.get(self, "timeoutsInput"))
    ...
    def bucket_name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataHcpPackerImageIteration, "bucket_name").fset)
    ...
    def channel(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataHcpPackerImageIteration, "channel").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataHcpPackerImageIteration, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class DataHcpPackerImageIterationBuildsImagesList(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DataHcpPackerImageIterationBuildsImagesList.__init__)
    ...
    def get(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DataHcpPackerImageIterationBuildsImagesList.get)
    ...
    def _terraform_attribute(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataHcpPackerImageIterationBuildsImagesList, "_terraform_attribute").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def _terraform_resource(self, value: cdktf.IInterpolatingParent) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataHcpPackerImageIterationBuildsImagesList, "_terraform_resource").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def _wraps_set(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataHcpPackerImageIterationBuildsImagesList, "_wraps_set").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class DataHcpPackerImageIterationBuildsImagesOutputReference(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DataHcpPackerImageIterationBuildsImagesOutputReference.__init__)
            check_type(argname="argument terraform_resource", value=terraform_resource, expected_type=type_hints["terraform_resource"])
            check_type(argname="argument terraform_attribute", value=terraform_attribute, expected_type=type_hints["terraform_attribute"])
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataHcpPackerImageIterationBuildsImagesOutputReference, "internal_value").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class DataHcpPackerImageIterationBuildsList(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DataHcpPackerImageIterationBuildsList.__init__)
            check_type(argname="argument terraform_resource", value=terraform_resource, expected_type=type_hints["terraform_resource"])
            check_type(argname="argument terraform_attribute", value=terraform_attribute, expected_type=type_hints["terraform_attribute"])
            check_type(argname="argument wraps_set", value=wraps_set, expected_type=type_hints["wraps_set"])
        jsii.create(self.__class__, self, [terraform_resource, terraform_attribute, wraps_set])
    ...
    def get(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DataHcpPackerImageIterationBuildsList.get)
            check_type(argname="argument index", value=index, expected_type=type_hints["index"])
    ...
    def _terraform_attribute(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataHcpPackerImageIterationBuildsList, "_terraform_attribute").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "terraformAttribute", value)
    ...
    def _terraform_resource(self, value: cdktf.IInterpolatingParent) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataHcpPackerImageIterationBuildsList, "_terraform_resource").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "terraformResource", value)
    ...
    def _wraps_set(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataHcpPackerImageIterationBuildsList, "_wraps_set").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "wrapsSet", value)
...
class DataHcpPackerImageIterationBuildsOutputReference(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DataHcpPackerImageIterationBuildsOutputReference.__init__)
            check_type(argname="argument terraform_resource", value=terraform_resource, expected_type=type_hints["terraform_resource"])
            check_type(argname="argument terraform_attribute", value=terraform_attribute, expected_type=type_hints["terraform_attribute"])
            check_type(argname="argument complex_object_index", value=complex_object_index, expected_type=type_hints["complex_object_index"])
            check_type(argname="argument complex_object_is_from_set", value=complex_object_is_from_set, expected_type=type_hints["complex_object_is_from_set"])
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataHcpPackerImageIterationBuildsOutputReference, "internal_value").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
...
class DataHcpPackerImageIterationConfig(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        connection: typing.Optional[typing.Union[typing.Union[cdktf.SSHProvisionerConnection, typing.Dict[str, typing.Any]], typing.Union[cdktf.WinrmProvisionerConnection, typing.Dict[str, typing.Any]]]] = None,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(DataHcpPackerImageIterationConfig.__init__)
...
class DataHcpPackerImageIterationTimeouts:
    def __init__(self, *, default: typing.Optional[builtins.str] = None) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DataHcpPackerImageIterationTimeouts.__init__)
...
class DataHcpPackerImageIterationTimeoutsOutputReference(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DataHcpPackerImageIterationTimeoutsOutputReference.__init__)
            check_type(argname="argument terraform_resource", value=terraform_resource, expected_type=type_hints["terraform_resource"])
            check_type(argname="argument terraform_attribute", value=terraform_attribute, expected_type=type_hints["terraform_attribute"])
    ...
    def default(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataHcpPackerImageIterationTimeoutsOutputReference, "default").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[DataHcpPackerImageIterationTimeouts, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[DataHcpPackerImageIterationTimeouts, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataHcpPackerImageIterationTimeoutsOutputReference, "internal_value").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
