...
EMAIL_RECEIVERS = 'vbalakrishna@knoema.com' #'third-party-data-etl@knoema.com'
...
class KnoemaDocumentUploader():
    ...
    def FileUpload(self,self.CLIENT,headers=headers):
        ...
        try:
            ...
            with smtplib.SMTP('smtp.gmail.com',587) as smtp:
                ...
                smtp.sendmail(EMAIL_ADDRESS,HARD_STOP_EMAIL_RECEIVERS.split(","),msg)
