...
umbral_opt, opt_list = hcm.get_umbral_opt(list_path=["cv_test_false\\cv"],n_splits=20,postfix="123",intervalo=0.01)

import statistics

mean_ = statistics.mean(opt_list)           
pstdev_ = statistics.pstdev(opt_list)
min_ = min(opt_list)           
max_ = max(opt_list)  
