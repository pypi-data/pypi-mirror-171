...
class Enum(StandardEnum):
    """Same as the standard [`enum.Enum`][enum.Enum], emulating functionality of
...
class IntEnum(StandardIntEnum, Enum):
    """Same as the standard [`enum.IntEnum`][enum.IntEnum], emulating functionality of
...
class StringEnum(str, Enum):
    """Same as the standard string enumerations, emulating functionality of
...
class Flag(StandardFlag, Enum):
    """Same as the standard [`enum.Flag`][enum.Flag], emulating functionality of
...
class IntFlag(StandardIntFlag, Flag):  # type: ignore
    """Same as the standard [`enum.IntFlag`][enum.IntFlag], emulating functionality of
