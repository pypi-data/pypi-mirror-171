...
class ConfigApi(object):
    ...
    def get_config_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/lcm/v4.0.a1/resources/config', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='lcm.v4.resources.GetLcmConfigApiResponse',  # noqa: E501
    ...
    def put_config(self, **kwargs):  # noqa: E501
        ...
        >>> response = api.put_config((optional) body)
        ...
        :param lcm.v4.resources.LcmConfig body:
        :param bool async_req:
    ...
    def put_config_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/lcm/v4.0.a1/resources/config', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='lcm.v4.resources.PutLcmConfigApiResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
