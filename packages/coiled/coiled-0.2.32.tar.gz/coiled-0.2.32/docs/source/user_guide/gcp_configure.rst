...
You should also make sure you have the `gcloud CLI <https://cloud.google.com/sdk/docs/install>`_ installed and the following APIs enabled (see the `Google Cloud documentation on enabling APIs <https://cloud.google.com/endpoints/docs/openapi/enable-api>`_ for more details):

- `Artifact Registry <https://cloud.google.com/artifact-registry/docs/enable-service>`_ (see the :ref:`Configure Google Artifact Registry <gar>` section below)
