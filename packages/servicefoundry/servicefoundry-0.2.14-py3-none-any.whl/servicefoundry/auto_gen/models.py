...
#   timestamp: 2022-10-06T06:01:08+00:00
...
class BitbucketSource(BaseModel):
    """
        +label=Bitbucket
    +icon=fa-brands fa-bitbucket:black
    """

    type: constr(regex=r"bitbucket")
    repo_url: str = Field(
...
class InstanceConfig(BaseModel):
    instance_family: List[str] = Field(
        ...,
        description="+usage=Instance family of the underlying machine to use - [docs](https://aws.amazon.com/ec2/instance-types/).\nMultiple instance families can be supplied. The workload is guranteed to be scheduled on one of them.",
    )
...
class Build(BaseModel):
    ...
    build_source: Union[
        RemoteSource, GithubSource, BitbucketSource, LocalSource
    ] = Field(
        ...,
