...
class Status(object):
    ...
    def __init__(self, description=None, operation_done=None, state=None, *args, **kwargs):  # noqa: E501
        """Status - a model defined in Swagger
            \nStatus of a task
        """
    ...
    def _initialize_object_type(self):
        return 'lcm.v4.resources.Status'

    def _initialize_fq_object_type(self):
        return 'lcm.v4.r0.a1.resources.Status'
