...
class Company(DateTimeMixin, CRUDMixin, db.Model):
    """
    Company model
    """
...
class CompanyLocation(DateTimeMixin, CRUDMixin, db.Model):
    """
...
class CompanyPrinter(DateTimeMixin, CRUDMixin, db.Model):
    """
