...
class ThreatInsightSettings(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ThreatInsightSettings.__init__)
    ...
    def action(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ThreatInsightSettings, "action").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ThreatInsightSettings, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def network_excludes(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ThreatInsightSettings, "network_excludes").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class ThreatInsightSettingsConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(ThreatInsightSettingsConfig.__init__)
