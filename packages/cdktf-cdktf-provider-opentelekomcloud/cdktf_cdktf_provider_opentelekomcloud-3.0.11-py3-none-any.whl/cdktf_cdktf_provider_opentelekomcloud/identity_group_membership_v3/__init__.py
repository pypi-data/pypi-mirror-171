...
class IdentityGroupMembershipV3(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IdentityGroupMembershipV3.__init__)
    ...
    def group(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IdentityGroupMembershipV3, "group").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IdentityGroupMembershipV3, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def users(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IdentityGroupMembershipV3, "users").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class IdentityGroupMembershipV3Config(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(IdentityGroupMembershipV3Config.__init__)
