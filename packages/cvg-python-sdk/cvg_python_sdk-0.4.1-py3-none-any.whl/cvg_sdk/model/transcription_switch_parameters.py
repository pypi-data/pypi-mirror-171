...
class TranscriptionSwitchParameters(
        ...
        class all_of_1(
            ...
            class MetaOapg:
                ...
                class properties:
                    ...
                    @staticmethod
                    def transcribers() -> typing.Type['TranscriberSelection']:
                        return TranscriberSelection
                    __annotations__ = {
                        "language": language,
            ...
            @typing.overload
            def __getitem__(self, name: typing_extensions.Literal["transcribers"]) -> 'TranscriberSelection': ...
            
            @typing.overload
            def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
            
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["language", "transcribers", ], str]):
            ...
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["transcribers"]) -> typing.Union['TranscriberSelection', schemas.Unset]: ...
            
            @typing.overload
            def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
            
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["language", "transcribers", ], str]):
            ...
            def __new__(
                ...
                *args: typing.Union[dict, frozendict.frozendict, ],
                ...
                transcribers: typing.Union['TranscriberSelection', schemas.Unset] = schemas.unset,
