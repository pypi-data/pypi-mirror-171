...
class CollectMetrics(object):
    """CollectMetrics - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def __init__(self, collect_metrics=False, *args, **kwargs):  # noqa: E501
        """CollectMetrics - a model defined in Swagger
            \nCollect metrics boolean attribute
        """
        self.__collect_metrics = None
        self.discriminator = None
        if collect_metrics is not None:
            self.__collect_metrics = collect_metrics
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'lcm.v4.common.CollectMetrics'

    def _initialize_fq_object_type(self):
        return 'lcm.v4.r0.a1.common.CollectMetrics'
    ...
    def to_dict(self):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CollectMetrics, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CollectMetrics):
            return False
