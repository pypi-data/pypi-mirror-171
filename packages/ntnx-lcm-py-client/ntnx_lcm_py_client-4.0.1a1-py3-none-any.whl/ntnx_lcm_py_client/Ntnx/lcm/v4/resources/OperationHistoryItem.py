...
class OperationHistoryItem(object):
    """OperationHistoryItem - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_object_type(self):
        return 'lcm.v4.resources.OperationHistoryItem'

    def _initialize_fq_object_type(self):
        return 'lcm.v4.r0.a1.resources.OperationHistoryItem'
    ...
    def to_dict(self):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OperationHistoryItem, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OperationHistoryItem):
            return False
