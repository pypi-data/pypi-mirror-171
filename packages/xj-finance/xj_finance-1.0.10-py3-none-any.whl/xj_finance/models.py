...
class Transact(models.Model):
    ...
    their_account = models.ForeignKey(verbose_name='对方账户', to=BaseInfo, db_column='their_account_id', related_name='their_account_set',
                                      on_delete=models.DO_NOTHING, db_constraint=False)
    ...
    currency = models.ForeignKey(verbose_name='币种', to=Currency, db_column='currency_id', related_name='+', on_delete=models.DO_NOTHING, default=1, unique=False, blank=True, null=True, help_text='')
    ...
    pay_mode = models.ForeignKey(verbose_name='支付方式', to=PayMode, db_column='pay_mode_id', on_delete=models.DO_NOTHING, unique=False, blank=True, null=True, default=5)
    ...
    sand_box = models.ForeignKey(verbose_name='沙盒', to=SandBox, db_column='sand_box_id', related_name='+', on_delete=models.DO_NOTHING, unique=False, blank=True, null=True, db_index=True)
