...
class PrincipalTypeByPrincipalValue(object):
    """PrincipalTypeByPrincipalValue - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    swagger_types = {
        ...
        'protocol_type': 'files.v4.config.ProtocolTypeMountTarget',
    ...
    def __init__(self, principal_value=None, principal_type=None, protocol_type=None, *args, **kwargs):  # noqa: E501
        """PrincipalTypeByPrincipalValue - a model defined in Swagger
    ...
    def _initialize_object_type(self):
        return 'files.v4.config.PrincipalTypeByPrincipalValue'

    def _initialize_fq_object_type(self):
        return 'files.v4.r0.a2.config.PrincipalTypeByPrincipalValue'
    ...
    def to_dict(self):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PrincipalTypeByPrincipalValue, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PrincipalTypeByPrincipalValue):
            return False
