...
class DataNomadJobParser(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DataNomadJobParser.__init__)
    ...
    def canonicalize(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataNomadJobParser, "canonicalize").fset)
    ...
    def hcl(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataNomadJobParser, "hcl").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataNomadJobParser, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class DataNomadJobParserConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(DataNomadJobParserConfig.__init__)
