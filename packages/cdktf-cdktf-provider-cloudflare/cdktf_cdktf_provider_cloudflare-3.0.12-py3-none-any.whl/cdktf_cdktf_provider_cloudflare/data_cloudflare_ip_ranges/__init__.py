...
class DataCloudflareIpRanges(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DataCloudflareIpRanges.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataCloudflareIpRanges, "id").fset)
...
class DataCloudflareIpRangesConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(DataCloudflareIpRangesConfig.__init__)
