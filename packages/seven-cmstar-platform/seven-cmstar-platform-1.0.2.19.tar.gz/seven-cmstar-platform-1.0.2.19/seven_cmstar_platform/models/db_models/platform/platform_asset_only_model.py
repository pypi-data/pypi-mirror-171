...
class PlatformAssetOnlyModel(BaseModel):
    def __init__(self, db_connect_key='db_platform', sub_table=None, db_transaction=None, context=None):
        super(PlatformAssetOnlyModel, self).__init__(PlatformAssetOnly, sub_table)
...
class PlatformAssetOnly:

    def __init__(self):
        super(PlatformAssetOnly, self).__init__()
        self.id = 0  # id
