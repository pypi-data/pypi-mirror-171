...
class DataCloudflareApiTokenPermissionGroups(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DataCloudflareApiTokenPermissionGroups.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataCloudflareApiTokenPermissionGroups, "id").fset)
...
class DataCloudflareApiTokenPermissionGroupsConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(DataCloudflareApiTokenPermissionGroupsConfig.__init__)
