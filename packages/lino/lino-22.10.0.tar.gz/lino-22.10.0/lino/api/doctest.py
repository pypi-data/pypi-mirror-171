...
def get_fields(model, fieldnames=None):
...
def fields_help(model, fieldnames=None, columns=False, all=None):
    ...
    for fld in get_fields(model, fieldnames):
...
def show_field_translations(model, fieldnames, languages=None, wrap_width=40):
    """
