...
class LambdaToOpenSearch(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LambdaToOpenSearch.__init__)
    ...
    def open_search_domain(self) -> aws_cdk.aws_opensearchservice.CfnDomain:
        return typing.cast(aws_cdk.aws_opensearchservice.CfnDomain, jsii.get(self, "openSearchDomain"))

    @builtins.property
    @jsii.member(jsii_name="openSearchRole")
    def open_search_role(self) -> aws_cdk.aws_iam.Role:
        return typing.cast(aws_cdk.aws_iam.Role, jsii.get(self, "openSearchRole"))
...
class LambdaToOpenSearchProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(LambdaToOpenSearchProps.__init__)
