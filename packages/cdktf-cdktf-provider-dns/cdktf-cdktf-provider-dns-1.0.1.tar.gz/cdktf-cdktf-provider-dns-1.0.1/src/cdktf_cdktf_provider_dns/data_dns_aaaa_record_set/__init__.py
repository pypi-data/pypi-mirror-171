...
class DataDnsAaaaRecordSet(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DataDnsAaaaRecordSet.__init__)
    ...
    def host(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataDnsAaaaRecordSet, "host").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataDnsAaaaRecordSet, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class DataDnsAaaaRecordSetConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(DataDnsAaaaRecordSetConfig.__init__)
