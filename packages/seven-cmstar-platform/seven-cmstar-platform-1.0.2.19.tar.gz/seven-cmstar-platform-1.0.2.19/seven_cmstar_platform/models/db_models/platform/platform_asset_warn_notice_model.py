...
class PlatformAssetWarnNoticeModel(BaseModel):
    def __init__(self, db_connect_key='db_platform', sub_table=None, db_transaction=None, context=None):
        super(PlatformAssetWarnNoticeModel, self).__init__(PlatformAssetWarnNotice, sub_table)
...
class PlatformAssetWarnNotice:

    def __init__(self):
        super(PlatformAssetWarnNotice, self).__init__()
        self.id = 0  # id
        self.app_id = ""  # 应用标识
        self.act_id = 0  # 活动标识
        self.user_id = 0  # 用户标识
    ...
    def __str__(self):
        return "platform_asset_warn_notice_tb"
