...
def add_or_update_mitre_model_version(
    ...
    :param str model: The threat model of the MITRE category
    :param str version: Version of the MITRE ATT\&CK release
...
def get_mitre_category_relationship(
    ...
    :param str idOrExtId: ID or ExtID of the MITRE category relationship \(external ID requires an additional query parameter\: version\)
    :param str version: Which version to use with external ID
    :param json: return the response's body as a ``dict`` parsed from json. ``True`` by
      default. If set to false, the raw ``requests.Response`` object will be returned.
    :param verify: path to a certificate bundle or boolean indicating whether SSL
...
def get_mitre_model_version(
    ...
    """Gets an existing MITRE model version info (DEV)
...
def list_mitre_model_versions(
    ...
    """Lists existing MITRE model version info per model (DEV)
