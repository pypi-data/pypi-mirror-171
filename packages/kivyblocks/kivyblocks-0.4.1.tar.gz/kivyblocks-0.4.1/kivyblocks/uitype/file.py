...
def build_input_file_widget(desc, rec=None):
...
def build_view_file_widget(desc, rec=None):
...
UiFactory.register('code', build_input_file_widget, build_view_file_widget)
