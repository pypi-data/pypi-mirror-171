...
class IntegrationAwsLambdaArn(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IntegrationAwsLambdaArn.__init__)
    ...
    def account_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IntegrationAwsLambdaArn, "account_id").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IntegrationAwsLambdaArn, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def lambda_arn(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IntegrationAwsLambdaArn, "lambda_arn").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class IntegrationAwsLambdaArnConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(IntegrationAwsLambdaArnConfig.__init__)
