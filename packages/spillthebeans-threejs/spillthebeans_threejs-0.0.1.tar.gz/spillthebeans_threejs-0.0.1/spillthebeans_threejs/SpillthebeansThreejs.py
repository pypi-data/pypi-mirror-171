...
- rotation (number; required)"""
    ...
    @_explicitize_args
    def __init__(self, id=Component.REQUIRED, rotation=Component.REQUIRED, maxAngle=Component.REQUIRED, axis=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'maxAngle', 'rotation']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'maxAngle', 'rotation']
