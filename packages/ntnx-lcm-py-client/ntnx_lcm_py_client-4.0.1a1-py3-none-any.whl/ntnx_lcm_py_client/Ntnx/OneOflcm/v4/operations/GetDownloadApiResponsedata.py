...
class GetDownloadApiResponsedata(object):
    """GetDownloadApiResponsedata - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_object_type(self):
        return 'OneOflcm.v4.operations.GetDownloadApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetDownloadApiResponsedata.discriminator_value_class_map.values():
            return list(GetDownloadApiResponsedata.discriminator_value_class_map.keys())[list(GetDownloadApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
    ...
    def to_dict(self):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GetDownloadApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetDownloadApiResponsedata):
            return False
