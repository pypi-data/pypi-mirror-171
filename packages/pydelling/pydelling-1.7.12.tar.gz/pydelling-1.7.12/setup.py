...
setup(
    ...
    version='1.7.12',  # Start with a small number and increase it with every change you make
    ...
    download_url='https://github.com/aitirga/pydelling/archive/refs/tags/v_1.7.12sh pus.zip',  # I explain this later on
