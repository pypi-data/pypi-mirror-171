...
import six
from ntnx_lcm_py_client.Ntnx.lcm.v4.resources.LcmImageDetails import LcmImageDetails  # noqa: F401,E501
...
class LcmBundle(object):
    """LcmBundle - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    swagger_types = {
        ...
        'size': 'str',
        'type': 'str',
        'images': 'list[lcm.v4.resources.LcmImageDetails]',
    ...
    def __init__(self, name=None, uuid=None, size=None, type=None, images=None, *args, **kwargs):  # noqa: E501
        """LcmBundle - a model defined in Swagger
    ...
    def _initialize_object_type(self):
        return 'lcm.v4.resources.LcmBundle'

    def _initialize_fq_object_type(self):
        return 'lcm.v4.r0.a1.resources.LcmBundle'
    ...
    @property
    def images(self):
        """`{ list[lcm.v4.resources.LcmImageDetails] }`
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LcmBundle):
            return False
