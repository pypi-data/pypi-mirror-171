...
class UserRole(
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(UserRole, "id").fset)
    ...
    def role(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(UserRole, "role").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def user_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(UserRole, "user_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
