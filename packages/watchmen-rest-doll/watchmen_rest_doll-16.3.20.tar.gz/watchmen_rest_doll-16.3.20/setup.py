...
['bcrypt>=3.2.0,<4.0.0',
 ...
 'watchmen-data-surface==16.3.20',
 'watchmen-indicator-surface==16.3.20',
 'watchmen-inquiry-surface==16.3.20',
 'watchmen-pipeline-surface==16.3.20']

extras_require = \
{'collector': ['watchmen-collector-kernel==16.3.20'],
 ...
 'mysql': ['watchmen-storage-mysql==16.3.20', 'cryptography>=36.0.2,<37.0.0'],
