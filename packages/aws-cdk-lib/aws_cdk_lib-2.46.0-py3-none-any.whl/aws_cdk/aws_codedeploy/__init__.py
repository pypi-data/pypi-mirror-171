...
class BaseDeploymentConfig(
    ...
    Example::
        ...
        base_deployment_config = codedeploy.BaseDeploymentConfig.deployment_config("name")
    '''
    ...
    @jsii.member(jsii_name="deploymentConfig")
    @builtins.classmethod
    def deployment_config(cls, name: builtins.str) -> IBaseDeploymentConfig:
        ...
        :return: a reference to an existing custom Deployment Configuration
        '''
        if __debug__:
            type_hints = typing.get_type_hints(BaseDeploymentConfig.deployment_config)
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
        return typing.cast(IBaseDeploymentConfig, jsii.sinvoke(cls, "deploymentConfig", [name]))
...
class EcsDeploymentConfig(
    ...
    def ALL_AT_ONCE(cls) -> IBaseDeploymentConfig:
        '''CodeDeploy predefined deployment configuration that shifts all traffic to the updated ECS task set at once.'''
        return typing.cast(IBaseDeploymentConfig, jsii.sget(cls, "ALL_AT_ONCE"))

    @jsii.python.classproperty
    @jsii.member(jsii_name="CANARY_10PERCENT_15MINUTES")
    def CANARY_10_PERCENT_15_MINUTES(cls) -> IBaseDeploymentConfig:
        ...
        '''
        return typing.cast(IBaseDeploymentConfig, jsii.sget(cls, "CANARY_10PERCENT_15MINUTES"))

    @jsii.python.classproperty
    @jsii.member(jsii_name="CANARY_10PERCENT_5MINUTES")
    def CANARY_10_PERCENT_5_MINUTES(cls) -> IBaseDeploymentConfig:
        '''CodeDeploy predefined deployment configuration that shifts 10 percent of traffic in the first increment.

        The remaining 90 percent is deployed five minutes later.
        '''
        return typing.cast(IBaseDeploymentConfig, jsii.sget(cls, "CANARY_10PERCENT_5MINUTES"))

    @jsii.python.classproperty
    @jsii.member(jsii_name="LINEAR_10PERCENT_EVERY_1MINUTES")
    def LINEAR_10_PERCENT_EVERY_1_MINUTES(cls) -> IBaseDeploymentConfig:
        ...
        return typing.cast(IBaseDeploymentConfig, jsii.sget(cls, "LINEAR_10PERCENT_EVERY_1MINUTES"))

    @jsii.python.classproperty
    @jsii.member(jsii_name="LINEAR_10PERCENT_EVERY_3MINUTES")
    def LINEAR_10_PERCENT_EVERY_3_MINUTES(cls) -> IBaseDeploymentConfig:
        ...
        return typing.cast(IBaseDeploymentConfig, jsii.sget(cls, "LINEAR_10PERCENT_EVERY_3MINUTES"))
...
class LambdaDeploymentConfig(
    ...
    def CANARY_10_PERCENT_10_MINUTES(cls) -> IBaseDeploymentConfig:
        '''CodeDeploy predefined deployment configuration that shifts 10 percent of traffic in the first increment.

        The remaining 90 percent is deployed 10 minutes later.
        '''
        return typing.cast(IBaseDeploymentConfig, jsii.sget(cls, "CANARY_10PERCENT_10MINUTES"))
    ...
    def CANARY_10_PERCENT_30_MINUTES(cls) -> IBaseDeploymentConfig:
        '''CodeDeploy predefined deployment configuration that shifts 10 percent of traffic in the first increment.

        The remaining 90 percent is deployed 30 minutes later.
        '''
        return typing.cast(IBaseDeploymentConfig, jsii.sget(cls, "CANARY_10PERCENT_30MINUTES"))
    ...
    def LINEAR_10_PERCENT_EVERY_10_MINUTES(cls) -> IBaseDeploymentConfig:
        ...
        return typing.cast(IBaseDeploymentConfig, jsii.sget(cls, "LINEAR_10PERCENT_EVERY_10MINUTES"))

    @jsii.python.classproperty
    @jsii.member(jsii_name="LINEAR_10PERCENT_EVERY_1MINUTE")
    def LINEAR_10_PERCENT_EVERY_1_MINUTE(cls) -> IBaseDeploymentConfig:
        '''CodeDeploy predefined deployment configuration that shifts 10 percent of traffic every minute until all traffic is shifted.'''
        return typing.cast(IBaseDeploymentConfig, jsii.sget(cls, "LINEAR_10PERCENT_EVERY_1MINUTE"))

    @jsii.python.classproperty
    @jsii.member(jsii_name="LINEAR_10PERCENT_EVERY_2MINUTES")
    def LINEAR_10_PERCENT_EVERY_2_MINUTES(cls) -> IBaseDeploymentConfig:
        ...
        return typing.cast(IBaseDeploymentConfig, jsii.sget(cls, "LINEAR_10PERCENT_EVERY_2MINUTES"))
