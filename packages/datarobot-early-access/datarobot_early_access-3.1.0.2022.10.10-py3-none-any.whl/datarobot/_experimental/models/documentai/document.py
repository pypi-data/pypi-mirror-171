...
FeaturesWithSamples = namedtuple("FeaturesWithSamples", ["model_id", "feature_name"])
...
class DocumentTextExtractionSampleDocument(APIObject):
    ...
    @classmethod
    def list(cls, model_id: str, feature_name: str) -> List[DocumentTextExtractionSampleDocument]:
        """
...
class DocumentTextExtractionSamplePage(APIObject):
    ...
    @classmethod
    def list(
        cls, model_id: str, feature_name: str, document_index: Optional[int] = None
        ...
        params = dict(feature_name=feature_name)
        if document_index:
            params = dict(params, document_index=str(document_index))
...
class DocumentTextExtractionSample(APIObject):
    ...
    def list_pages(
        ...
        return DocumentTextExtractionSamplePage.list(
            model_id=model_id, feature_name=feature_name, document_index=document_index
        )
