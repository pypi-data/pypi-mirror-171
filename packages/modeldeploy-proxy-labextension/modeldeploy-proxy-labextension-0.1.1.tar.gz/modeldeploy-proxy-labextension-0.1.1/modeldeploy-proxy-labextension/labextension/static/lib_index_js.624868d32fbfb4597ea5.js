...
/* harmony import */ var _widgets_TransformerLeftPanel__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./widgets/TransformerLeftPanel */ "./lib/widgets/TransformerLeftPanel.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
    ...
    requires: [_jupyterlab_application__WEBPACK_IMPORTED_MODULE_0__.ILabShell, _jupyterlab_settingregistry__WEBPACK_IMPORTED_MODULE_6__.ISettingRegistry, _jupyterlab_application__WEBPACK_IMPORTED_MODULE_0__.ILayoutRestorer, _jupyterlab_notebook__WEBPACK_IMPORTED_MODULE_3__.INotebookTracker, _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.IToolbarWidgetRegistry],
    optional: [_jupyterlab_translation__WEBPACK_IMPORTED_MODULE_2__.ITranslator],
    autoStart: true,
    activate: async (app, labShell, settingRegistry, restorer, tracker, toolbarRegistry, translator) => {
        Promise.all([settingRegistry.load(_settings__WEBPACK_IMPORTED_MODULE_7__.SETTINGS_ID)]).then(([settings]) => {
        ...
        app.started.then(() => {
            widget = _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.ReactWidget.create(react__WEBPACK_IMPORTED_MODULE_4__.createElement(_widgets_TransformerLeftPanel__WEBPACK_IMPORTED_MODULE_8__.TransformerLeftPanel, { tracker: tracker, transformerSettings: transformerSettings }));
...
const createCellTransformerWidgets = (notebookPanel, cellElement, transformerTag) => {
    ...
    react_dom__WEBPACK_IMPORTED_MODULE_5__.render(react__WEBPACK_IMPORTED_MODULE_4__.createElement(_widgets_CellMetadataEditor__WEBPACK_IMPORTED_MODULE_7__.CellMetadataEditor, { notebookPanel: notebookPanel, cellElement: cellElement, transformerTag: transformerTag }), newChildNode);
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
...
class TransformerLeftPanel extends react__WEBPACK_IMPORTED_MODULE_0__.Component {
    constructor(props) {
        ...
        this.getActiveNotebookFileName = () => {
            return this.props.tracker.currentWidget.title.label;
        };
        this.getActiveNotebookPath = () => {
            return (this.getActiveNotebookPanel() && _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_2__.PageConfig.getOption('serverRoot') + '/' + this.getActiveNotebookPanel().context.path);
        };
        this.componentDidMount = () => {
            // Notebook tracker will signal when a notebook is changed
            console.log("transformerEnabled = " + (0,_settings__WEBPACK_IMPORTED_MODULE_3__.getTransformerEnabled)(this.props.transformerSettings));
        };
        ...
        this.applyTransformerToProxy = async () => {
            ...
            console.log(this.getActiveNotebookFileName());
        ...
        const defaultState = {
            isEnabled: (0,_settings__WEBPACK_IMPORTED_MODULE_3__.getTransformerEnabled)(this.props.transformerSettings)
        };
        this.state = defaultState;
    }
    render() {
...
//# sourceMappingURL=lib_index_js.624868d32fbfb4597ea5.js.map