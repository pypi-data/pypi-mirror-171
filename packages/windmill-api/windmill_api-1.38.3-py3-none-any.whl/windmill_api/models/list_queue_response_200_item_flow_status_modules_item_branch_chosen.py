...
class ListQueueResponse200ItemFlowStatusModulesItemBranchChosen:
    ...
    type: Union[Unset, ListQueueResponse200ItemFlowStatusModulesItemBranchChosenType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_type, Unset):
            type = ListQueueResponse200ItemFlowStatusModulesItemBranchChosenType(_type)
