...
class HostCatalogStatic(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(HostCatalogStatic.__init__)
    ...
    def description(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(HostCatalogStatic, "description").fset)
    ...
    def name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(HostCatalogStatic, "name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def scope_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(HostCatalogStatic, "scope_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class HostCatalogStaticConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(HostCatalogStaticConfig.__init__)
