                        ...
                        for feature in feature_lst:
                            if(isinstance(feature, ResGene)
                               or isinstance(feature, ResMutation)):
                                ...
                                for unique_id, group_feat in feature.items():
                                    if isinstance(group_feat, ResMutation):
                                        if unique_id in phenotype.get("seq_variations", ()):
                                            continue
                                        phenotype.add_feature(res_collection, isolate, group_feat)
