...
class GooglePubsubSubscriptionIamPolicy(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(GooglePubsubSubscriptionIamPolicy.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(GooglePubsubSubscriptionIamPolicy, "id").fset)
    ...
    def policy_data(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(GooglePubsubSubscriptionIamPolicy, "policy_data").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def project(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(GooglePubsubSubscriptionIamPolicy, "project").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def subscription(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(GooglePubsubSubscriptionIamPolicy, "subscription").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class GooglePubsubSubscriptionIamPolicyConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(GooglePubsubSubscriptionIamPolicyConfig.__init__)
