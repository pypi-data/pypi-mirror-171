...
class ProtectedEntity(object):
    """ProtectedEntity - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def __init__(self, source_mount_target_ext_id=None, source_mount_target_path=None, target_mount_target_ext_id=None, *args, **kwargs):  # noqa: E501
        """ProtectedEntity - a model defined in Swagger
    ...
    def _initialize_object_type(self):
        return 'files.v4.config.ProtectedEntity'

    def _initialize_fq_object_type(self):
        return 'files.v4.r0.a2.config.ProtectedEntity'
