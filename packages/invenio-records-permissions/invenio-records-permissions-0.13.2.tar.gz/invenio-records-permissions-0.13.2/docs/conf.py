...
project = u'Invenio-Records-Permissions'
...
with open(os.path.join(os.path.dirname(__file__), '..',
                       'invenio_records_permissions', 'version.py'),
          'rt') as fp:
    exec(fp.read(), g)
...
latex_documents = [
    (master_doc, 'invenio-records-permissions.tex', u'invenio-records-permissions Documentation',
     u'CERN', 'manual'),
]
