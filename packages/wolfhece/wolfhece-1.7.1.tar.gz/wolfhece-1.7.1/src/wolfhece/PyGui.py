...
class Wolf2DModel(GenMapManager):
    ...
    def extend_bed_elevation(self):
        ...
        self.top.mngselection.condition_select(2,0.,True)
    ...
    def extend_freesurface_elevation(self,selection:list):
        ...
        self.hbin.mngselection.condition_select(4,0.,True)
        ...
        self.hbin.mngselection.myselection = selection.copy()
        self.hbin.mngselection.condition_select(2,0.,True)
    ...
    def extend_roughness(self,selection:list):
        ...
        self.frot.mngselection.condition_select(0,oldval,True)
        self.frot.mngselection.condition_select(4,oldval,True)
        ...
        self.frot.mngselection.myselection = sel.copy()
        self.frot.mngselection.condition_select(2,oldval,True)
        ...
        self.frot.mngselection.myselection = nullvalues.copy()
