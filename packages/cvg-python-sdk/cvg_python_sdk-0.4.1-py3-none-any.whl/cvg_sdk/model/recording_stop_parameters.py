...
class RecordingStopParameters(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["terminate"]) -> MetaOapg.properties.terminate: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["dialogId", "recordingId", "terminate", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["terminate"]) -> typing.Union[MetaOapg.properties.terminate, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["dialogId", "recordingId", "terminate", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        terminate: typing.Union[MetaOapg.properties.terminate, bool, schemas.Unset] = schemas.unset,
