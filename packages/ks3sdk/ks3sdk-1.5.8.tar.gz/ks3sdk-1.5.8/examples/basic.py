...
def uploadObjectFromString():
  bucket = conn.get_bucket(bucket_name)
  k = bucket.new_key('test_encryption_multi2')
...
# listObjects()
# listObjectsMore("finder-create", marker='album.html')
...
# test_fetch_object()
# test_generate_url('article.txt', image_attrs='@base@tag=imgScale&w=500')
...
# key = copy('article.txt.copied2', 'article.txt', dst_bucket_name='test-bucket')
# print(key.etag)
