...
def sql_injection_scanner(url, secure = True, bot = False):
    ...
    mal_sql = ["\"", "\'", ";", "*", "'or''='", '"or""="', 'support"or"1"="1', "support'or'1'='1", "support@" + str(email_mal) + '"or"1"="1', "support@" + str(email_mal) + "'or'1'='1", '=support"or"1"="1', "=support'or'1'='1", "=support@" + str(email_mal) + '"or"1"="1', "=support@" + str(email_mal) + "'or'1'='1"]
