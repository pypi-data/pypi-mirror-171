...
class PredicateType(enum.Enum):
    ...
    PREDICATE_EXPRESSION = 'predicate-expression'
...
@dataclass
class AlwaysTrueAssignmentAccuracyPredicate(AssignmentAccuracyPredicate):
    threshold: Optional[PredicateValue] = None
...
class ActionType(enum.Enum):
    ...
    GIVE_BONUS_TO_USER = 'give-bonus-to-user'
    SET_ASSIGNMENT_STATUS = 'set-assignment-status'
