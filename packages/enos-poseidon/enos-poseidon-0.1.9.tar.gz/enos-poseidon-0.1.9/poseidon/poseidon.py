...
def urlopen(key, secret, url, data=None, headers=None, method=None, timeout=None, content_type=None):
    if headers is None:
        headers = {}
    ...
    if data is not None:
        ...
        if isinstance(data, dict):
            ...
            content_type = 'application/json;charset=utf-8' if content_type is None else content_type
