...
from zik.client.external_task_client import ExternalTaskClient
from zik.external_task.external_task import TaskResult, ExternalTask
from zik.external_task.external_task_worker import ExternalTaskWorker


class ExternalTaskWorkerTest(TestCase):

    @responses.activate
    @patch('zik.client.external_task_client.ExternalTaskClient.complete')
