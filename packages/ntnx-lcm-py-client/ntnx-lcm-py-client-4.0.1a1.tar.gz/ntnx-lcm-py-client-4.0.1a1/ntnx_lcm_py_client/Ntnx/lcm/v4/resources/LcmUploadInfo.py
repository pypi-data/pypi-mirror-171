...
class LcmUploadInfo(object):
    """LcmUploadInfo - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_object_type(self):
        return 'lcm.v4.resources.LcmUploadInfo'

    def _initialize_fq_object_type(self):
        return 'lcm.v4.r0.a1.resources.LcmUploadInfo'
    ...
    def to_dict(self):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LcmUploadInfo, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LcmUploadInfo):
            return False
