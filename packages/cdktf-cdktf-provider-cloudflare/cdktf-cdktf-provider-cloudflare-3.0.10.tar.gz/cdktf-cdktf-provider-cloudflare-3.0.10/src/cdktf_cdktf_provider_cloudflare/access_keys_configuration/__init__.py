...
class AccessKeysConfiguration(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AccessKeysConfiguration.__init__)
    ...
    def account_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(AccessKeysConfiguration, "account_id").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(AccessKeysConfiguration, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def key_rotation_interval_days(self, value: jsii.Number) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(AccessKeysConfiguration, "key_rotation_interval_days").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class AccessKeysConfigurationConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(AccessKeysConfigurationConfig.__init__)
