...
class GoogleSourcerepoRepositoryIamPolicy(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(GoogleSourcerepoRepositoryIamPolicy.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(GoogleSourcerepoRepositoryIamPolicy, "id").fset)
    ...
    def policy_data(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(GoogleSourcerepoRepositoryIamPolicy, "policy_data").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def project(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(GoogleSourcerepoRepositoryIamPolicy, "project").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def repository(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(GoogleSourcerepoRepositoryIamPolicy, "repository").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class GoogleSourcerepoRepositoryIamPolicyConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(GoogleSourcerepoRepositoryIamPolicyConfig.__init__)
