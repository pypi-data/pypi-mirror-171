...
class DataDnsARecordSet(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DataDnsARecordSet.__init__)
    ...
    def host(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataDnsARecordSet, "host").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataDnsARecordSet, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class DataDnsARecordSetConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(DataDnsARecordSetConfig.__init__)
