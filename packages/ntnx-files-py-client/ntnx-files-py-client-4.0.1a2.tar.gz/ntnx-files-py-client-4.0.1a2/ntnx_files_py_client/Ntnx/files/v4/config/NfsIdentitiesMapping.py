...
class NfsIdentitiesMapping(object):
    """NfsIdentitiesMapping - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def __init__(self, mapping_type=None, action_type=None, name=None, *args, **kwargs):  # noqa: E501
        """NfsIdentitiesMapping - a model defined in Swagger
            \nNFS mapping model.
        """
    ...
    def _initialize_object_type(self):
        return 'files.v4.config.NfsIdentitiesMapping'

    def _initialize_fq_object_type(self):
        return 'files.v4.r0.a2.config.NfsIdentitiesMapping'
    ...
    def to_dict(self):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NfsIdentitiesMapping, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NfsIdentitiesMapping):
            return False
