...
class ErrorCode(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Enum of error code responses., must be one of ["MissingIndexError", "LuceneParseError", "HttpClientError", "AccumuloError", "TableNotFoundError", "SecurityError", "AuthError", "BadRequestError", ]  # noqa: E501

        Keyword Args:
            value (str): Enum of error code responses., must be one of ["MissingIndexError", "LuceneParseError", "HttpClientError", "AccumuloError", "TableNotFoundError", "SecurityError", "AuthError", "BadRequestError", ]  # noqa: E501
