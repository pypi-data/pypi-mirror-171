...
from spt_datascience.resources import ModelManagerResource, PipelineManagerResource
from spt_datascience.credentials import ModelManagerCredentials, PipelineManagerCredentials
