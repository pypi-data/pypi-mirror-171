...
from mongoengine import Document, StringField, ObjectIdField, DateTimeField, IntField, FloatField, BooleanField, ListField, ReferenceField
...
class MongoJob(Document):
    ...
    topic = StringField(required=False)
    history = ListField(ReferenceField(MongoJobHistory), max_length=20)
