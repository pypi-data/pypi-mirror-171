...
from ntnx_lcm_py_client.Ntnx.OneOflcm.v4.error.ErrorResponseerror import ErrorResponseerror  # noqa: F401,E501
...
class ErrorResponse(object):
    ...
    """ # noqa: E501
    swagger_types = {
        'error': 'OneOflcm.v4.error.ErrorResponseerror',
    ...
    def _initialize_object_type(self):
        return 'lcm.v4.error.ErrorResponse'

    def _initialize_fq_object_type(self):
        return 'lcm.v4.r0.a1.error.ErrorResponse'
    ...
    @property
    def error(self):
        """`{ list[lcm.v4.error.AppMessage] | lcm.v4.error.SchemaValidationError }`
