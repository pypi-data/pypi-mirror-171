...
class DataNomadPlugins(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DataNomadPlugins.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataNomadPlugins, "id").fset)
    ...
    def type(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataNomadPlugins, "type").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class DataNomadPluginsConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(DataNomadPluginsConfig.__init__)
