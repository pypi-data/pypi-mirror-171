...
class EmulatedView(View):
    ...
    def _render(self, request = None, response = None, account = None,
        ...
        ctxtdct['source'] = self.source # XXX Must use native('source', path) in triggers.
        ...
        if requestAdapter is None:
            if request is None:
                ...
                requestAdapter = self._RequestAdapter(request, query = queryString)
