from src.pega_orchestrator_environment.orchestrator import orchestrator

## Orchestrator initalisation
orchestrator = orchestrator.PegaOrchestratorEnvrionment("orchestrator", "https://sleij.pegatsdemo.com/prweb")
