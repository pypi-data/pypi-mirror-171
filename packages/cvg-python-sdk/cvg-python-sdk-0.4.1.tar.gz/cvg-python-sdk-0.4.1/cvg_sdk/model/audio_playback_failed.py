...
class AudioPlaybackFailed(
    ...
    Playback of the given audio file URL failed.
    """
    ...
    class MetaOapg:
        ...
        class all_of_1(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["url", "errorCode", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["url", "errorCode", ], str]):
