    ...
    class MetaOapg:
        ...
        class all_of_1(
            ...
            class MetaOapg:
                ...
                class properties:
                    tone = schemas.StrSchema
                    __annotations__ = {
                        "tone": tone,
                    }
            
            tone: MetaOapg.properties.tone
            
            @typing.overload
            def __getitem__(self, name: typing_extensions.Literal["tone"]) -> MetaOapg.properties.tone: ...
            
            @typing.overload
            def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
            
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["tone", ], str]):
                # dict_instance[name] accessor
                return super().__getitem__(name)
            
            
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["tone"]) -> MetaOapg.properties.tone: ...
            
            @typing.overload
            def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
            
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["tone", ], str]):
            ...
            def __new__(
                ...
                *args: typing.Union[dict, frozendict.frozendict, ],
                tone: typing.Union[MetaOapg.properties.tone, str, ],
