        ...
        while True:
            ...
            try:
                ...
                if resp.status_code == 200:
                    ...
                    self.log.error("Ошибка при обновлении result_data задачи", {
                        "task": task
                    })
                    time.sleep(15)
            except requests.exceptions.ConnectionError:
                """
                Любые сетевые ошибки пропускаем и пробуем сделать запрос снова - нам нужен корректный ответ
                Мы точно должны записать результаты выполнения в БД
                """
                pass
            except Exception:
