...
class BaseMagicDotPath:
    ...
    def __eq__(self, other: _OTHER_TYPE) -> MagicDotPathWithOp:  # type: ignore
        """
        Get a MagicDotPathWithOp objects with a `=` operator and the correct types.
    ...
    def __ne__(self, other: _OTHER_TYPE) -> MagicDotPathWithOp:  # type: ignore
        """
        Get a MagicDotPathWithOp objects with a `<>` operator and the correct types.
    ...
    def __radd__(self, other: _OTHER_TYPE) -> MagicDotPathWithOp:
        ...
        This operator is ussfull when we make `8 + MagicDotPath`
