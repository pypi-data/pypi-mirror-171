 ...
 */
const Jijsplash: JupyterFrontEndPlugin<ISplashScreen> = {
  id: 'jijzeptlab_themes:splash',
  autoStart: true,
  ...
  activate: (app: JupyterFrontEnd, translator: ITranslator) => {
    ...
    galaxy.id = 'galaxy';
    logo.id = 'main-logo';
    // const labIcon = new LabIcon({ name: 'logo-test', svgstr: logoSvg });
    // labIcon.element({
    //   container: logo,
    //   stylesheet: 'splash'
    // });
    // new jupyterFaviconIcon({ name: 'favicon-test', svgstr: logoSvg });
