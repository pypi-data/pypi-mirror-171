...
class EventHookVerification(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EventHookVerification.__init__)
    ...
    def event_hook_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(EventHookVerification, "event_hook_id").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(EventHookVerification, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class EventHookVerificationConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(EventHookVerificationConfig.__init__)
