...
if __name__ == '__main__':
    ...
    config = pull_configuration_from_firestore(db, "261.13", "labshowroom-001")
    machines = pull_docs_from_collection_associated_with_configuration(
        db, "machines", config.reference
    )
    machines
