...
class VbsBackupShareV2(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(VbsBackupShareV2.__init__)
    ...
    def backup_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(VbsBackupShareV2, "backup_id").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(VbsBackupShareV2, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def region(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(VbsBackupShareV2, "region").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def to_project_ids(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(VbsBackupShareV2, "to_project_ids").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class VbsBackupShareV2Config(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(VbsBackupShareV2Config.__init__)
...
class VbsBackupShareV2Timeouts:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(VbsBackupShareV2Timeouts.__init__)
...
class VbsBackupShareV2TimeoutsOutputReference(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(VbsBackupShareV2TimeoutsOutputReference.__init__)
    ...
    def create(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(VbsBackupShareV2TimeoutsOutputReference, "create").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def delete(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(VbsBackupShareV2TimeoutsOutputReference, "delete").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(VbsBackupShareV2TimeoutsOutputReference, "internal_value").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
