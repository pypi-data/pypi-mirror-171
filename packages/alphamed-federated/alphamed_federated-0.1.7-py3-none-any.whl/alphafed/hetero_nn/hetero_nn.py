...
from .contractor import (CheckinEvent, CollaboraterCompleteEvent,
...
class HeteroNNHostScheduler(HeteroNNScheduler):
    ...
    def _distribute_feature_grad(self):
        """Distribute feature grad tensors to collaboraters."""
        ...
        self.push_log('Distributed all features grad tensors to collaboraters.')
