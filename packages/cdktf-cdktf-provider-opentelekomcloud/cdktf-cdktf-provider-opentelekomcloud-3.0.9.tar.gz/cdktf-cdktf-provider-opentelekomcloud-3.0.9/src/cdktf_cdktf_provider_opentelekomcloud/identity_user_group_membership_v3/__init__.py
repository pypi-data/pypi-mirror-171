...
class IdentityUserGroupMembershipV3(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IdentityUserGroupMembershipV3.__init__)
    ...
    def groups(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IdentityUserGroupMembershipV3, "groups").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IdentityUserGroupMembershipV3, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def user(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IdentityUserGroupMembershipV3, "user").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class IdentityUserGroupMembershipV3Config(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(IdentityUserGroupMembershipV3Config.__init__)
