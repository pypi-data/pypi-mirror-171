...
def load_synthetic_data(args):
    ...
    if dataset_name == "mnist":
        ...
        # If MNIST/train does not exist, download it.
        # Otherwise, just proceed with the loading
        # This avoids race conditions when multiple clients access the same files
        if not os.path.isdir(os.path.join(args.data_cache_dir, "MNIST", "train")):
