...
class RoleSubscription(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RoleSubscription.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(RoleSubscription, "id").fset)
    ...
    def notification_type(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(RoleSubscription, "notification_type").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def role_type(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(RoleSubscription, "role_type").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def status(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(RoleSubscription, "status").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class RoleSubscriptionConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(RoleSubscriptionConfig.__init__)
