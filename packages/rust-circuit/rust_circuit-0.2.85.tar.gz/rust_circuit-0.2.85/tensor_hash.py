...
tensor_hash_cache: Dict[int, bytes] = {}

# this doesn't produce consistent hashes, ??? caught by test_rust_printing
# def hash_tensor(tensor):
#     # maybe identity by id is sketchy???
#     if id(tensor) in tensor_hash_cache:
#         return tensor_hash_cache[id(tensor)]
#     hash_out = hash_tensor_impl(tensor)
#     tensor_hash_cache[id(tensor)] = hash_out
#     return hash_out
