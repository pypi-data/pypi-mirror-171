...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{class:_vm.$style.container,on:{"mousedown":_vm.onMouseDown}},[_c('div',{class:_vm.$style.inside},[_c('display-area',{attrs:{"name":_vm.name,"origin":_vm.origin}}),_vm._t("default")],2)])}
var staticRenderFns = []
...
// CONCATENATED MODULE: ./src/components/RemoteControlledArea/script.js?vue&type=script&lang=js&
 /* harmony default export */ var RemoteControlledArea_scriptvue_type_script_lang_js_ = (scriptvue_type_script_lang_js_); 
...
var component = normalizeComponent(
  RemoteControlledArea_scriptvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
/* harmony default export */ var RemoteControlledArea = (component.exports);
...
var templatevue_type_template_id_6618e8dc_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticStyle:{"width":"100%","height":"100%"}},[_c('image-display-area',{attrs:{"name":_vm.name,"origin":_vm.origin,"poolSize":4}}),_c('video-display-area',{attrs:{"name":_vm.name,"origin":_vm.origin}})],1)}
var templatevue_type_template_id_6618e8dc_staticRenderFns = []
...
/* harmony default export */ var ImageDisplayArea_scriptvue_type_script_lang_js_ = ({
...
// CONCATENATED MODULE: ./src/components/ImageDisplayArea/script.js?vue&type=script&lang=js&
 /* harmony default export */ var components_ImageDisplayArea_scriptvue_type_script_lang_js_ = (ImageDisplayArea_scriptvue_type_script_lang_js_); 
...
var ImageDisplayArea_component = normalizeComponent(
  components_ImageDisplayArea_scriptvue_type_script_lang_js_,
...
/* harmony default export */ var ImageDisplayArea = (ImageDisplayArea_component.exports);
...
class VideoDecoder {
  constructor(videoElement, mime = 'video/webm; codecs=vp09.00.10.08') {
    ...
    this.queue = [];
    this.loaded = 0; // redefine push such that it appends only when it is safe to do so.
...
/* harmony default export */ var VideoDisplayArea_scriptvue_type_script_lang_js_ = ({
  ...
  mounted() {
    console.log('mounted video vue component'); // create a video decoder with that video tag
...
var DisplayArea_component = normalizeComponent(
  ...
  templatevue_type_template_id_6618e8dc_render,
  templatevue_type_template_id_6618e8dc_staticRenderFns,
  false,
  null,
  null,
  null
