...
class Interpreter:
    ...
    def InterpretInstruction(self, instruction: ast.AST, scope):
        #print("Interpret Instruction: ", instruction, " token: ", instruction.Token)
    ...
    def GetEmptyRecord(self, fields: typing.List[ast_select_field.SelectField]) -> value_item.ValueItem:
        ...
        for fld in fields:
            return_data.Value[fld.AsName] = value_item.ValueItem().SetFromMacal(None, types.VariableTypes.Nil, types.VariableTypes.Nil)
        return return_data
    ...
    def ApplyFieldFilters(self, data: value_item.ValueItem, fields: typing.List[ast_select_field.SelectField]) -> value_item.ValueItem:
        ...
        if data is None:
            ...
            r = value_item.ValueItem().SetFromMacal(data.Token, data.Type, {})
            for fld in fields:
