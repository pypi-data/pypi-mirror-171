...
class Transform(google.protobuf.message.Message):
    ...
    class Spec(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal[u"automatic_user_settings",b"automatic_user_settings",u"cast",b"cast",u"composed",b"composed",u"external",b"external",u"filter",b"filter",u"identity",b"identity",u"inverse_transcode",b"inverse_transcode",u"join",b"join",u"project",b"project",u"protect_dataset",b"protect_dataset",u"protected_paths",b"protected_paths",u"public_paths",b"public_paths",u"sample",b"sample",u"shuffle",b"shuffle",u"spec",b"spec",u"synthetic",b"synthetic",u"transcode",b"transcode",u"user_settings",b"user_settings",u"variable",b"variable"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal[u"automatic_user_settings",b"automatic_user_settings",u"cast",b"cast",u"composed",b"composed",u"external",b"external",u"filter",b"filter",u"identity",b"identity",u"inverse_transcode",b"inverse_transcode",u"join",b"join",u"project",b"project",u"protect_dataset",b"protect_dataset",u"protected_paths",b"protected_paths",u"public_paths",b"public_paths",u"sample",b"sample",u"shuffle",b"shuffle",u"spec",b"spec",u"synthetic",b"synthetic",u"transcode",b"transcode",u"user_settings",b"user_settings",u"variable",b"variable"]) -> None: ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal[u"spec",b"spec"]) -> typing.Optional[typing_extensions.Literal["identity","variable","composed","project","filter","shuffle","join","cast","sample","user_settings","protect_dataset","external","synthetic","transcode","inverse_transcode","protected_paths","automatic_user_settings","public_paths"]]: ...
