...
class EntityApi(object):
    ...
    def get_entities(self, **kwargs):  # noqa: E501
        ...
        >>> response = api.get_entities((optional) _page, (optional) _limit, (optional) _filter)
        ...
        :return: lcm.v4.resources.GetEntitiesApiResponse
    ...
    def get_entities_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/lcm/v4.0.a1/resources/entities', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='lcm.v4.resources.GetEntitiesApiResponse',  # noqa: E501
    ...
    def get_entity(self, uuid, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_entity(uuid, async_req=True)
        >>> result = thread.get()

        :param str uuid: UUID of the entity to be used (required)
        :param bool async_req:
        :return: lcm.v4.resources.GetEntityApiResponse
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_entity_with_http_info(uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_entity_with_http_info(uuid, **kwargs)  # noqa: E501
            return data

    def get_entity_with_http_info(self, uuid, **kwargs):  # noqa: E501
        """Get details about an LCM entity
        Get details about an LCM entity
        ...
        >>> thread = api.get_entity_with_http_info(uuid, async_req=True)
        >>> result = thread.get()
        ...
        if ('uuid' not in params or
                params['uuid'] is None):
            raise ValueError("Missing the required parameter `uuid` when calling `get_entity`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/lcm/v4.0.a1/resources/entities/{uuid}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='lcm.v4.resources.GetEntityApiResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
