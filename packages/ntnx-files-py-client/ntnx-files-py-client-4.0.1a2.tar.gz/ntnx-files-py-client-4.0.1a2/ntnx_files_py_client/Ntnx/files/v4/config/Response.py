...
class Response(ExternalizableAbstractModel):
    ...
    def __init__(self, status=False, is_status=False, message=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        """Response - a model defined in Swagger
            \nGeneric CRUD response details
        """
        ExternalizableAbstractModel.__init__(self, ext_id, links, tenant_id, *args, **kwargs)
        self.__status = None
        self.__is_status = None
        self.__message = None
    ...
    def _initialize_object_type(self):
        return 'files.v4.config.Response'

    def _initialize_fq_object_type(self):
        return 'files.v4.r0.a2.config.Response'
