...
class ZoneDnssec(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ZoneDnssec.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ZoneDnssec, "id").fset)
    ...
    def modified_on(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ZoneDnssec, "modified_on").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def zone_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ZoneDnssec, "zone_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class ZoneDnssecConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(ZoneDnssecConfig.__init__)
