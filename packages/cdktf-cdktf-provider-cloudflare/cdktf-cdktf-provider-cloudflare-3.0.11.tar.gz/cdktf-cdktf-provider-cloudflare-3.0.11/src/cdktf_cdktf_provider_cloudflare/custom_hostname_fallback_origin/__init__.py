...
class CustomHostnameFallbackOrigin(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CustomHostnameFallbackOrigin.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CustomHostnameFallbackOrigin, "id").fset)
    ...
    def origin(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CustomHostnameFallbackOrigin, "origin").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def zone_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CustomHostnameFallbackOrigin, "zone_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class CustomHostnameFallbackOriginConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(CustomHostnameFallbackOriginConfig.__init__)
